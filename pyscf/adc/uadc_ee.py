...
#TPDM
        ...
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,Jmab,Lmab->IJKL', np.identity(nocc_a), Y_aaaa, Y_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,Ja,La->IJKL', np.identity(nocc_a), Y_aa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,Jmab,Lmab->IJKL', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Jmab,Kmab->IJKL', np.identity(nocc_a), Y_aaaa, Y_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Ja,Ka->IJKL', np.identity(nocc_a), Y_aa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Jmab,Kmab->IJKL', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,Imab,Lmab->IJKL', np.identity(nocc_a), Y_aaaa, Y_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,Ia,La->IJKL', np.identity(nocc_a), Y_aa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,Imab,Lmab->IJKL', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Imab,Kmab->IJKL', np.identity(nocc_a), Y_aaaa, Y_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Ia,Ka->IJKL', np.identity(nocc_a), Y_aa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Imab,Kmab->IJKL', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        ...
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('mnab,mnab,IK,JL->IJKL', Y_aaaa, Y_aaaa, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('mnab,mnab,IL,JK->IJKL', Y_aaaa, Y_aaaa, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('ma,ma,IK,JL->IJKL', Y_aa, Y_aa, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('ma,ma,IL,JK->IJKL', Y_aa, Y_aa, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('mnab,mnab,IK,JL->IJKL', Y_abab, Y_abab, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('mnab,mnab,IL,JK->IJKL', Y_abab, Y_abab, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('mnab,mnab,IK,JL->IJKL', Y_bbbb, Y_bbbb, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('mnab,mnab,IL,JK->IJKL', Y_bbbb, Y_bbbb, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('ma,ma,IK,JL->IJKL', Y_bb, Y_bb, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('ma,ma,IL,JK->IJKL', Y_bb, Y_bb, np.identity(nocc_a), np.identity(nocc_a), optimize = True)
        ...
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,Ja,Lmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,Ja,Lmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,La,Jmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,La,Jmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Ja,Kmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Ja,Kmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Ka,Jmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,Ka,Jmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,Ia,Lmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,Ia,Lmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,La,Imab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,La,Imab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Ia,Kmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Ia,Kmab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Ka,Imab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,Ka,Imab,mb->IJKL', np.identity(nocc_a), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('IK,Ja,ma,mnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IK,Ja,ma,mb,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IK,Ja,ma,mnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,Ja,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,Ja,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,Ja,mb,Lnac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,Ja,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('IK,La,ma,mnbc,Jnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IK,La,ma,mb,Jb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IK,La,ma,mnbc,Jnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,La,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,La,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,La,mb,Jnac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,La,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,ma,ma,Jnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,ma,Jb,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,ma,Jnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,mb,Ja,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,mb,Jnac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,mb,Jnac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IK,ma,na,Jmbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,nb,Jmac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,nb,Jmac,Lncb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IK,ma,ma,Jnbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,ma,Jb,Lb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,ma,Jnbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,mb,Jnca,Lncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,nb,Jmca,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IK,ma,na,Jmbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IK,ma,nb,Jmca,Lncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('IL,Ja,ma,mnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IL,Ja,ma,mb,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IL,Ja,ma,mnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ja,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ja,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ja,mb,Knac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ja,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('IL,Ka,ma,mnbc,Jnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IL,Ka,ma,mb,Jb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IL,Ka,ma,mnbc,Jnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ka,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ka,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ka,mb,Jnac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,Ka,mb,Jnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,ma,ma,Jnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,ma,Jb,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,ma,Jnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,mb,Ja,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,mb,Jnac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,mb,Jnac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('IL,ma,na,Jmbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,nb,Jmac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,nb,Jmac,Kncb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('IL,ma,ma,Jnbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,ma,Jb,Kb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,ma,Jnbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,mb,Jnca,Kncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,nb,Jmca,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('IL,ma,na,Jmbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('IL,ma,nb,Jmca,Kncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('JK,Ia,ma,mnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JK,Ia,ma,mb,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JK,Ia,ma,mnbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,Ia,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,Ia,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,Ia,mb,Lnac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,Ia,mb,Lnac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/4 * lib.einsum('JK,La,ma,mnbc,Inbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JK,La,ma,mb,Ib->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JK,La,ma,mnbc,Inbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,La,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,La,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,La,mb,Inac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,La,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,ma,ma,Inbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,ma,Ib,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,ma,Inbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,mb,Ia,Lb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,mb,Inac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,mb,Inac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JK,ma,na,Imbc,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,nb,Imac,Lnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,nb,Imac,Lncb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JK,ma,ma,Inbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,ma,Ib,Lb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,ma,Inbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,mb,Inca,Lncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,nb,Imca,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JK,ma,na,Imbc,Lnbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JK,ma,nb,Imca,Lncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('JL,Ia,ma,mnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JL,Ia,ma,mb,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JL,Ia,ma,mnbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ia,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ia,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ia,mb,Knac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ia,mb,Knac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/4 * lib.einsum('JL,Ka,ma,mnbc,Inbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JL,Ka,ma,mb,Ib->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JL,Ka,ma,mnbc,Inbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ka,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ka,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ka,mb,Inac,nmcb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,Ka,mb,Inac,mnbc->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,ma,ma,Inbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,ma,Ib,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,ma,Inbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,mb,Ia,Kb->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,mb,Inac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,mb,Inac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += 1/2 * lib.einsum('JL,ma,na,Imbc,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,nb,Imac,Knbc->IJKL', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,nb,Imac,Kncb->IJKL', np.identity(nocc_a), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= 1/2 * lib.einsum('JL,ma,ma,Inbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,ma,Ib,Kb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,ma,Inbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,mb,Inca,Kncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,nb,Imca,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] += lib.einsum('JL,ma,na,Imbc,Knbc->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        temp_2a[:nocc_a,:nocc_a,:nocc_a,:nocc_a] -= lib.einsum('JL,ma,nb,Imca,Kncb->IJKL', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
...
#        print("Total TPDM  Hermiticity",norm)
#        norm = np.linalg.norm(temp_2a + temp_2a.transpose(1,0,2,3))
#        print("Total TPDM bra symmetry",norm)
#        norm = np.linalg.norm(temp_2a + temp_2a.transpose(0,1,3,2))
#        print("Total TPDM ket symmetry",norm)
#        print("TPDM trace",np.einsum('pqpq',temp_2a))
#        spin = 0
        ...
        OoOo  = lib.einsum('Ijab,Klab->IjKl', Y_abab, Y_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,jmab,lmab->IjKl', np.identity(nocc_a), Y_bbbb, Y_bbbb, optimize = True)
        OoOo -= lib.einsum('IK,ja,la->IjKl', np.identity(nocc_a), Y_bb, Y_bb, optimize = True)
        OoOo -= lib.einsum('IK,mjab,mlab->IjKl', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Imab,Kmab->IjKl', np.identity(nocc_b), Y_aaaa, Y_aaaa, optimize = True)
        OoOo -= lib.einsum('jl,Ia,Ka->IjKl', np.identity(nocc_b), Y_aa, Y_aa, optimize = True)
        OoOo -= lib.einsum('jl,Imab,Kmab->IjKl', np.identity(nocc_b), Y_abab, Y_abab, optimize = True)
        OoOo += lib.einsum('Ia,Klab,jb->IjKl', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OoOo += lib.einsum('Ka,Ijab,lb->IjKl', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OoOo += lib.einsum('ja,Klba,Ib->IjKl', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OoOo += lib.einsum('la,Ijba,Kb->IjKl', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OoOo += 1/4 * lib.einsum('mnab,mnab,IK,jl->IjKl', Y_aaaa, Y_aaaa, np.identity(nocc_a), np.identity(nocc_b), optimize = True)
        OoOo += lib.einsum('ma,ma,IK,jl->IjKl', Y_aa, Y_aa, np.identity(nocc_a), np.identity(nocc_b), optimize = True)
        OoOo += lib.einsum('mnab,mnab,IK,jl->IjKl', Y_abab, Y_abab, np.identity(nocc_a), np.identity(nocc_b), optimize = True)
        OoOo += 1/4 * lib.einsum('mnab,mnab,IK,jl->IjKl', Y_bbbb, Y_bbbb, np.identity(nocc_a), np.identity(nocc_b), optimize = True)
        OoOo += lib.einsum('ma,ma,IK,jl->IjKl', Y_bb, Y_bb, np.identity(nocc_a), np.identity(nocc_b), optimize = True)
        OoOo += 1/2 * lib.einsum('Ia,Ka,jmbc,lmbc->IjKl', Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo += lib.einsum('Ia,Ka,jb,lb->IjKl', Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo += lib.einsum('Ia,Ka,mjbc,mlbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('Ia,Kb,mlac,mjbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('Ia,lb,Ka,jb->IjKl', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        OoOo += lib.einsum('Ia,lb,Kmac,mjcb->IjKl', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('Ia,lb,Kmac,jmbc->IjKl', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo -= lib.einsum('Ia,ma,mjbc,Klbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('Ia,mb,Klac,mjbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('Ia,mb,Klac,jmbc->IjKl', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo += lib.einsum('Ka,jb,Ia,lb->IjKl', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        OoOo += lib.einsum('Ka,jb,Imac,mlcb->IjKl', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('Ka,jb,Imac,lmbc->IjKl', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo -= lib.einsum('Ka,ma,mlbc,Ijbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('Ka,mb,Ijac,mlbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('Ka,mb,Ijac,lmbc->IjKl', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo += 1/2 * lib.einsum('ja,la,Imbc,Kmbc->IjKl', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo += lib.einsum('ja,la,Ib,Kb->IjKl', Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo += lib.einsum('ja,la,Imbc,Kmbc->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('ja,lb,Kmca,Imcb->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('ja,mb,Klca,Imbc->IjKl', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OoOo -= lib.einsum('ja,ma,Imbc,Klbc->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('ja,mb,Klca,Imcb->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('la,mb,Ijca,Kmbc->IjKl', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OoOo -= lib.einsum('la,ma,Kmbc,Ijbc->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('la,mb,Ijca,Kmcb->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('ma,ma,Ijbc,Klbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('ma,mb,Ijac,Klbc->IjKl', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('ma,ma,Ijbc,Klbc->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('ma,mb,Ijca,Klcb->IjKl', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('IK,ja,lmab,mb->IjKl', np.identity(nocc_a), t1_ce_bb, Y_bbbb, Y_bb, optimize = True)
        OoOo -= lib.einsum('IK,ja,mlba,mb->IjKl', np.identity(nocc_a), t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OoOo -= lib.einsum('IK,la,jmab,mb->IjKl', np.identity(nocc_a), t1_ce_bb, Y_bbbb, Y_bb, optimize = True)
        OoOo -= lib.einsum('IK,la,mjba,mb->IjKl', np.identity(nocc_a), t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OoOo -= lib.einsum('jl,Ia,Kmab,mb->IjKl', np.identity(nocc_b), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        OoOo -= lib.einsum('jl,Ia,Kmab,mb->IjKl', np.identity(nocc_b), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OoOo -= lib.einsum('jl,Ka,Imab,mb->IjKl', np.identity(nocc_b), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        OoOo -= lib.einsum('jl,Ka,Imab,mb->IjKl', np.identity(nocc_b), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ja,mb,lnac,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ja,mb,nlca,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OoOo += 1/4 * lib.einsum('IK,ja,ma,mnbc,lnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo += 1/2 * lib.einsum('IK,ja,ma,mb,lb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo += 1/2 * lib.einsum('IK,ja,ma,nmbc,nlbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ja,mb,lnac,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ja,mb,nlca,nmcb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,la,mb,jnac,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,la,mb,njca,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OoOo += 1/4 * lib.einsum('IK,la,ma,mnbc,jnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo += 1/2 * lib.einsum('IK,la,ma,mb,jb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo += 1/2 * lib.einsum('IK,la,ma,nmbc,njbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,la,mb,jnac,mnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,la,mb,njca,nmcb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ma,ma,jnbc,lnbc->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo -= lib.einsum('IK,ma,ma,jb,lb->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo -= lib.einsum('IK,ma,ma,njbc,nlbc->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('IK,ma,mb,njac,nlbc->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('IK,ma,na,mjbc,nlbc->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('IK,ma,nb,mjac,nlbc->IjKl', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('IK,ma,ma,jnbc,lnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo -= lib.einsum('IK,ma,ma,jb,lb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo -= lib.einsum('IK,ma,ma,njbc,nlbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('IK,ma,mb,ja,lb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OoOo += lib.einsum('IK,ma,mb,jnac,lnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo += lib.einsum('IK,ma,mb,njca,nlcb->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('IK,ma,nb,jmac,nlbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('IK,ma,nb,lmac,njbc->IjKl', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OoOo += 1/2 * lib.einsum('IK,ma,na,jmbc,lnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo -= lib.einsum('IK,ma,nb,jmac,lnbc->IjKl', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OoOo += 1/4 * lib.einsum('jl,Ia,ma,mnbc,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo += 1/2 * lib.einsum('jl,Ia,ma,mb,Kb->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo += 1/2 * lib.einsum('jl,Ia,ma,mnbc,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ia,mb,Knac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ia,mb,Knac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ia,mb,Knac,nmcb->IjKl', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ia,mb,Knac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo += 1/4 * lib.einsum('jl,Ka,ma,mnbc,Inbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo += 1/2 * lib.einsum('jl,Ka,ma,mb,Ib->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo += 1/2 * lib.einsum('jl,Ka,ma,mnbc,Inbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ka,mb,Inac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ka,mb,Inac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ka,mb,Inac,nmcb->IjKl', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,Ka,mb,Inac,mnbc->IjKl', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,ma,ma,Inbc,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo -= lib.einsum('jl,ma,ma,Ib,Kb->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo -= lib.einsum('jl,ma,ma,Inbc,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('jl,ma,mb,Ia,Kb->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo += lib.einsum('jl,ma,mb,Inac,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo += lib.einsum('jl,ma,mb,Inac,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += 1/2 * lib.einsum('jl,ma,na,Imbc,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo -= lib.einsum('jl,ma,nb,Imac,Knbc->IjKl', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo += lib.einsum('jl,ma,nb,Imac,Kncb->IjKl', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OoOo -= 1/2 * lib.einsum('jl,ma,ma,Inbc,Knbc->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OoOo -= lib.einsum('jl,ma,ma,Ib,Kb->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        OoOo -= lib.einsum('jl,ma,ma,Inbc,Knbc->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('jl,ma,mb,Inca,Kncb->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo += lib.einsum('jl,ma,nb,Imca,Knbc->IjKl', np.identity(nocc_b), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OoOo += lib.einsum('jl,ma,na,Imbc,Knbc->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OoOo -= lib.einsum('jl,ma,nb,Imca,Kncb->IjKl', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)

        VvVv  = lib.einsum('ijAb,ijCd->AbCd', Y_abab, Y_abab, optimize = True)
        VvVv += lib.einsum('iA,ijCd,jb->AbCd', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        VvVv += lib.einsum('iC,ijAb,jd->AbCd', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        VvVv += lib.einsum('ib,jiCd,jA->AbCd', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        VvVv += lib.einsum('id,jiAb,jC->AbCd', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        VvVv += lib.einsum('iA,iC,jb,jd->AbCd', Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        VvVv += lib.einsum('iA,iC,jkeb,jked->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += 1/2 * lib.einsum('iA,iC,jkbe,jkde->AbCd', Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        VvVv -= lib.einsum('iA,ie,jkeb,jkCd->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('iA,jC,iked,jkeb->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iA,je,ikCd,jkeb->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iA,jd,iC,jb->AbCd', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        VvVv += lib.einsum('iA,jd,ikCe,kjeb->AbCd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iA,jd,ikCe,jkbe->AbCd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        VvVv -= lib.einsum('iA,je,ikCd,jkbe->AbCd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        VvVv -= lib.einsum('iC,ie,jked,jkAb->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iC,je,ikAb,jked->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iC,jb,iA,jd->AbCd', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        VvVv += lib.einsum('iC,jb,ikAe,kjed->AbCd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('iC,jb,ikAe,jkde->AbCd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        VvVv -= lib.einsum('iC,je,ikAb,jkde->AbCd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        VvVv += lib.einsum('ie,ie,jkAb,jkCd->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('ie,je,ikAb,jkCd->AbCd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('ib,id,jA,jC->AbCd', Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        VvVv += 1/2 * lib.einsum('ib,id,jkAe,jkCe->AbCd', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        VvVv += lib.einsum('ib,id,jkAe,jkCe->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('ib,ie,jkAe,jkCd->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('ib,je,kiCd,jkAe->AbCd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        VvVv -= lib.einsum('ib,jd,kiCe,kjAe->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('ib,je,kiCd,kjAe->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('id,ie,jkCe,jkAb->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('id,je,kiAb,jkCe->AbCd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        VvVv += lib.einsum('id,je,kiAb,kjCe->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv += lib.einsum('ie,ie,jkAb,jkCd->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        VvVv -= lib.einsum('ie,je,kiAb,kjCd->AbCd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)


        OoVv  = lib.einsum('IC,jkda,ka->IjCd', t1_ce_aa, Y_bbbb, Y_bb, optimize = True)
        OoVv += lib.einsum('IC,kjad,ka->IjCd', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        OoVv -= lib.einsum('kC,ka,Ijad->IjCd', t1_ce_aa, Y_aa, Y_abab, optimize = True)
        OoVv += lib.einsum('IjCd,ka,ka->IjCd', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('IjCd,ka,ka->IjCd', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv -= lib.einsum('IjCa,ka,kd->IjCd', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv -= lib.einsum('Ijad,ka,kC->IjCd', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('IkCa,ka,jd->IjCd', t1_ccee_aaaa, Y_aa, Y_bb, optimize = True)
        OoVv -= lib.einsum('Ia,ka,kjCd->IjCd', t1_ce_aa, Y_aa, Y_abab, optimize = True)
        OoVv -= lib.einsum('IkCd,ka,ja->IjCd', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv += lib.einsum('IkCa,ka,jd->IjCd', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv += lib.einsum('jd,IkCa,ka->IjCd', t1_ce_bb, Y_aaaa, Y_aa, optimize = True)
        OoVv += lib.einsum('jd,IkCa,ka->IjCd', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        OoVv -= lib.einsum('kd,ka,IjCa->IjCd', t1_ce_bb, Y_bb, Y_abab, optimize = True)
        OoVv += lib.einsum('jkda,ka,IC->IjCd', t1_ccee_bbbb, Y_bb, Y_aa, optimize = True)
        OoVv -= lib.einsum('ja,ka,IkCd->IjCd', t1_ce_bb, Y_bb, Y_abab, optimize = True)
        OoVv -= lib.einsum('kjCd,ka,Ia->IjCd', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('kjad,ka,IC->IjCd', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('IjCd,ka,ka->IjCd', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('IjCd,ka,ka->IjCd', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv -= lib.einsum('IjCa,ka,kd->IjCd', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv -= lib.einsum('Ijad,ka,kC->IjCd', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('IkCa,ka,jd->IjCd', t2_ccee_aaaa, Y_aa, Y_bb, optimize = True)
        OoVv -= lib.einsum('IkCd,ka,ja->IjCd', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv += lib.einsum('IkCa,ka,jd->IjCd', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        OoVv += lib.einsum('jkda,ka,IC->IjCd', t2_ccee_bbbb, Y_bb, Y_aa, optimize = True)
        OoVv -= lib.einsum('kjCd,ka,Ia->IjCd', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv += lib.einsum('kjad,ka,IC->IjCd', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        OoVv -= lib.einsum('IC,ka,kd,ja->IjCd', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OoVv -= lib.einsum('Ia,ka,kC,jd->IjCd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OoVv -= lib.einsum('jd,ka,kC,Ia->IjCd', Y_bb, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OoVv -= lib.einsum('ja,ka,kd,IC->IjCd', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        OoVv -= lib.einsum('kC,ka,Ia,jd->IjCd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OoVv += lib.einsum('ka,ka,IC,jd->IjCd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OoVv -= lib.einsum('kd,ka,ja,IC->IjCd', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        OoVv += lib.einsum('ka,ka,IC,jd->IjCd', Y_bb, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)

        VvOo  = lib.einsum('KA,libc,ic->AbKl', t1_ce_aa, Y_bbbb, Y_bb, optimize = True)
        VvOo += lib.einsum('KA,ilcb,ic->AbKl', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        VvOo -= lib.einsum('iA,ic,Klcb->AbKl', t1_ce_aa, Y_aa, Y_abab, optimize = True)
        VvOo += lib.einsum('KlAb,ic,ic->AbKl', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('KlAb,ic,ic->AbKl', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo -= lib.einsum('KlAc,ic,ib->AbKl', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo -= lib.einsum('Klcb,ic,iA->AbKl', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('KiAc,ic,lb->AbKl', t1_ccee_aaaa, Y_aa, Y_bb, optimize = True)
        VvOo -= lib.einsum('Kc,ic,ilAb->AbKl', t1_ce_aa, Y_aa, Y_abab, optimize = True)
        VvOo -= lib.einsum('KiAb,ic,lc->AbKl', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo += lib.einsum('KiAc,ic,lb->AbKl', t1_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo += lib.einsum('lb,KiAc,ic->AbKl', t1_ce_bb, Y_aaaa, Y_aa, optimize = True)
        VvOo += lib.einsum('lb,KiAc,ic->AbKl', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        VvOo -= lib.einsum('ib,ic,KlAc->AbKl', t1_ce_bb, Y_bb, Y_abab, optimize = True)
        VvOo += lib.einsum('libc,ic,KA->AbKl', t1_ccee_bbbb, Y_bb, Y_aa, optimize = True)
        VvOo -= lib.einsum('lc,ic,KiAb->AbKl', t1_ce_bb, Y_bb, Y_abab, optimize = True)
        VvOo -= lib.einsum('ilAb,ic,Kc->AbKl', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('ilcb,ic,KA->AbKl', t1_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('KlAb,ic,ic->AbKl', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('KlAb,ic,ic->AbKl', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo -= lib.einsum('KlAc,ic,ib->AbKl', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo -= lib.einsum('Klcb,ic,iA->AbKl', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('KiAc,ic,lb->AbKl', t2_ccee_aaaa, Y_aa, Y_bb, optimize = True)
        VvOo -= lib.einsum('KiAb,ic,lc->AbKl', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo += lib.einsum('KiAc,ic,lb->AbKl', t2_ccee_abab, Y_bb, Y_bb, optimize = True)
        VvOo += lib.einsum('libc,ic,KA->AbKl', t2_ccee_bbbb, Y_bb, Y_aa, optimize = True)
        VvOo -= lib.einsum('ilAb,ic,Kc->AbKl', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo += lib.einsum('ilcb,ic,KA->AbKl', t2_ccee_abab, Y_aa, Y_aa, optimize = True)
        VvOo -= lib.einsum('KA,ic,ib,lc->AbKl', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        VvOo -= lib.einsum('Kc,ic,iA,lb->AbKl', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        VvOo -= lib.einsum('lb,ic,iA,Kc->AbKl', Y_bb, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        VvOo -= lib.einsum('lc,ic,ib,KA->AbKl', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        VvOo -= lib.einsum('iA,ic,Kc,lb->AbKl', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        VvOo += lib.einsum('ic,ic,KA,lb->AbKl', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        VvOo -= lib.einsum('ib,ic,lc,KA->AbKl', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        VvOo += lib.einsum('ic,ic,KA,lb->AbKl', Y_bb, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)

        OvOv =- lib.einsum('Ijbd,Kjba->IaKd', Y_abab, Y_abab, optimize = True)
        OvOv += lib.einsum('IK,jlba,jlbd->IaKd', np.identity(nocc_a), Y_abab, Y_abab, optimize = True)
        OvOv += lib.einsum('IK,ja,jd->IaKd', np.identity(nocc_a), Y_bb, Y_bb, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jlab,jldb->IaKd', np.identity(nocc_a), Y_bbbb, Y_bbbb, optimize = True)
        OvOv -= lib.einsum('Ib,Kjba,jd->IaKd', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OvOv -= lib.einsum('Kb,Ijbd,ja->IaKd', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        OvOv -= lib.einsum('ja,Ijbd,Kb->IaKd', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OvOv -= lib.einsum('jd,Kjba,Ib->IaKd', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OvOv -= lib.einsum('Ib,Kb,ja,jd->IaKd', Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv -= lib.einsum('Ib,Kb,jlca,jlcd->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/2 * lib.einsum('Ib,Kb,jlac,jldc->IaKd', Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv += lib.einsum('Ib,Kc,jlba,jlcd->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('Ib,jb,jlcd,Klca->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Ib,jc,Klba,jlcd->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Ib,ja,Kb,jd->IaKd', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        OvOv -= lib.einsum('Ib,ja,Klbc,ljcd->IaKd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Ib,ja,Klbc,jldc->IaKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvOv += lib.einsum('Ib,jc,Klba,jldc->IaKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvOv += lib.einsum('Kb,jb,jlca,Ilcd->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Kb,jc,Ilbd,jlca->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Kb,jd,Ib,ja->IaKd', Y_aa, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        OvOv -= lib.einsum('Kb,jd,Ilbc,ljca->IaKd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('Kb,jd,Ilbc,jlac->IaKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvOv += lib.einsum('Kb,jc,Ilbd,jlac->IaKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvOv -= lib.einsum('jb,jb,Ilcd,Klca->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('jb,jc,Ilbd,Klca->IaKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/2 * lib.einsum('ja,jd,Ilbc,Klbc->IaKd', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OvOv -= lib.einsum('ja,jd,Ib,Kb->IaKd', Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        OvOv -= lib.einsum('ja,jd,Ilbc,Klbc->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('ja,jb,Klcb,Ilcd->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('ja,lb,Ijcd,Klbc->IaKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvOv += lib.einsum('ja,ld,Ijbc,Klbc->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('ja,lb,Ijcd,Klcb->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('jd,jb,Ilcb,Klca->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('jd,lb,Kjca,Ilbc->IaKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvOv -= lib.einsum('jd,lb,Kjca,Ilcb->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('jb,jb,Ilcd,Klca->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('jb,lb,Ijcd,Klca->IaKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('IK,ja,jldb,lb->IaKd', np.identity(nocc_a), t1_ce_bb, Y_bbbb, Y_bb, optimize = True)
        OvOv += lib.einsum('IK,ja,ljbd,lb->IaKd', np.identity(nocc_a), t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OvOv += lib.einsum('IK,jd,jlab,lb->IaKd', np.identity(nocc_a), t1_ce_bb, Y_bbbb, Y_bb, optimize = True)
        OvOv += lib.einsum('IK,jd,ljba,lb->IaKd', np.identity(nocc_a), t1_ce_bb, Y_abab, Y_aa, optimize = True)
        OvOv += lib.einsum('IK,jb,jb,la,ld->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv += lib.einsum('IK,jb,jb,lmca,lmcd->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jb,jb,lmac,lmdc->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv -= lib.einsum('IK,jb,jc,lmba,lmcd->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('IK,jb,lb,jmca,lmcd->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('IK,jb,lc,jmba,lmcd->IaKd', np.identity(nocc_a), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/2 * lib.einsum('IK,ja,jb,lb,ld->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv -= 1/2 * lib.einsum('IK,ja,jb,lmcb,lmcd->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/4 * lib.einsum('IK,ja,jb,lmbc,lmdc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,ja,lb,jmdc,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,ja,lb,mjcd,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,ja,lb,jmdc,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,ja,lb,mjcd,mlcb->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/2 * lib.einsum('IK,jd,jb,lb,la->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv -= 1/2 * lib.einsum('IK,jd,jb,lmcb,lmca->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv -= 1/4 * lib.einsum('IK,jd,jb,lmbc,lmac->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jd,lb,jmac,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jd,lb,mjca,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jd,lb,jmac,lmbc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jd,lb,mjca,mlcb->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('IK,jb,jb,la,ld->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv += lib.einsum('IK,jb,jb,lmca,lmcd->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += 1/2 * lib.einsum('IK,jb,jb,lmac,lmdc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv -= 1/2 * lib.einsum('IK,jb,jc,lmab,lmdc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv -= lib.einsum('IK,jb,lc,jmab,lmcd->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('IK,jb,lc,jmdb,lmca->IaKd', np.identity(nocc_a), Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvOv -= lib.einsum('IK,jb,lb,ja,ld->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvOv -= lib.einsum('IK,jb,lb,jmac,lmdc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvOv -= lib.einsum('IK,jb,lb,mjca,mlcd->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvOv += lib.einsum('IK,jb,lc,jmab,lmdc->IaKd', np.identity(nocc_a), Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)

        oVoV =- lib.einsum('jiDb,jkAb->iAkD', Y_abab, Y_abab, optimize = True)
        oVoV += lib.einsum('ik,jA,jD->iAkD', np.identity(nocc_b), Y_aa, Y_aa, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jlAb,jlDb->iAkD', np.identity(nocc_b), Y_aaaa, Y_aaaa, optimize = True)
        oVoV += lib.einsum('ik,jlAb,jlDb->iAkD', np.identity(nocc_b), Y_abab, Y_abab, optimize = True)
        oVoV -= lib.einsum('jA,jiDb,kb->iAkD', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        oVoV -= lib.einsum('jD,jkAb,ib->iAkD', t1_ce_aa, Y_abab, Y_bb, optimize = True)
        oVoV -= lib.einsum('ib,jkAb,jD->iAkD', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        oVoV -= lib.einsum('kb,jiDb,jA->iAkD', t1_ce_bb, Y_abab, Y_aa, optimize = True)
        oVoV -= lib.einsum('ib,kb,jA,jD->iAkD', Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV -= 1/2 * lib.einsum('ib,kb,jlAc,jlDc->iAkD', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= lib.einsum('ib,kb,jlAc,jlDc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('ib,kc,jlAb,jlDc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ib,jA,kb,jD->iAkD', Y_bb, Y_aa, t1_ce_bb, t1_ce_aa, optimize = True)
        oVoV -= lib.einsum('ib,jA,klbc,jlDc->iAkD', Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ib,jA,lkcb,jlDc->iAkD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('ib,jc,lkAb,jlDc->iAkD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('ib,jb,ljDc,lkAc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ib,jc,lkAb,ljDc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('kb,jD,ib,jA->iAkD', Y_bb, Y_aa, t1_ce_bb, t1_ce_aa, optimize = True)
        oVoV -= lib.einsum('kb,jD,ilbc,jlAc->iAkD', Y_bb, Y_aa, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('kb,jD,licb,jlAc->iAkD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('kb,jc,liDb,jlAc->iAkD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('kb,jb,ljAc,liDc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('kb,jc,liDb,ljAc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= 1/2 * lib.einsum('jA,jD,ilbc,klbc->iAkD', Y_aa, Y_aa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        oVoV -= lib.einsum('jA,jD,ib,kb->iAkD', Y_aa, Y_aa, t1_ce_bb, t1_ce_bb, optimize = True)
        oVoV -= lib.einsum('jA,jD,libc,lkbc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jA,jb,lkbc,liDc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jA,lD,jibc,lkbc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('jA,lb,jiDc,lkbc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jA,lb,jiDc,klbc->iAkD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVoV += lib.einsum('jD,jb,libc,lkAc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('jD,lb,jkAc,libc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jD,lb,jkAc,ilbc->iAkD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVoV -= lib.einsum('jb,jb,liDc,lkAc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jb,lb,jiDc,lkAc->iAkD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('jb,jb,liDc,lkAc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('jb,jc,liDb,lkAc->iAkD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('ik,jA,jlDb,lb->iAkD', np.identity(nocc_b), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        oVoV += lib.einsum('ik,jA,jlDb,lb->iAkD', np.identity(nocc_b), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        oVoV += lib.einsum('ik,jD,jlAb,lb->iAkD', np.identity(nocc_b), t1_ce_aa, Y_aaaa, Y_aa, optimize = True)
        oVoV += lib.einsum('ik,jD,jlAb,lb->iAkD', np.identity(nocc_b), t1_ce_aa, Y_abab, Y_bb, optimize = True)
        oVoV -= 1/2 * lib.einsum('ik,jA,jb,lb,lD->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV -= 1/4 * lib.einsum('ik,jA,jb,lmbc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= 1/2 * lib.einsum('ik,jA,jb,lmbc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jA,lb,jmDc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jA,lb,jmDc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jA,lb,jmDc,mlcb->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jA,lb,jmDc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVoV -= 1/2 * lib.einsum('ik,jD,jb,lb,lA->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV -= 1/4 * lib.einsum('ik,jD,jb,lmbc,lmAc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= 1/2 * lib.einsum('ik,jD,jb,lmbc,lmAc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jD,lb,jmAc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jD,lb,jmAc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jD,lb,jmAc,mlcb->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jD,lb,jmAc,lmbc->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVoV += lib.einsum('ik,jb,jb,lA,lD->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jb,jb,lmAc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('ik,jb,jb,lmAc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= 1/2 * lib.einsum('ik,jb,jc,lmAb,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= lib.einsum('ik,jb,lb,jA,lD->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV -= lib.einsum('ik,jb,lb,jmAc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= lib.einsum('ik,jb,lb,jmAc,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('ik,jb,lc,jmAb,lmDc->iAkD', np.identity(nocc_b), Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV -= lib.einsum('ik,jb,lc,jmAb,mlDc->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ik,jb,lc,jmDb,mlAc->iAkD', np.identity(nocc_b), Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('ik,jb,jb,lA,lD->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        oVoV += 1/2 * lib.einsum('ik,jb,jb,lmAc,lmDc->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVoV += lib.einsum('ik,jb,jb,lmAc,lmDc->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ik,jb,jc,lmAb,lmDc->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV -= lib.einsum('ik,jb,lb,mjAc,mlDc->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVoV += lib.einsum('ik,jb,lc,mjAb,mlDc->iAkD', np.identity(nocc_b), Y_bb, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        
        OvoV =- lib.einsum('ID,ka->IakD', Y_aa, Y_bb, optimize = True)
        OvoV -= lib.einsum('IjDb,jkba->IakD', Y_aaaa, Y_abab, optimize = True)
        OvoV -= lib.einsum('IjDb,kjab->IakD', Y_abab, Y_bbbb, optimize = True)
        OvoV -= lib.einsum('ID,kjab,jb->IakD', t1_ce_aa, Y_bbbb, Y_bb, optimize = True)
        OvoV -= lib.einsum('ID,jkba,jb->IakD', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        OvoV += lib.einsum('jD,jkba,Ib->IakD', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        OvoV += lib.einsum('Ib,jkba,jD->IakD', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        OvoV -= lib.einsum('ka,IjDb,jb->IakD', t1_ce_bb, Y_aaaa, Y_aa, optimize = True)
        OvoV -= lib.einsum('ka,IjDb,jb->IakD', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        OvoV += lib.einsum('ja,IjDb,kb->IakD', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        OvoV += lib.einsum('kb,IjDb,ja->IakD', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        OvoV += 1/2 * lib.einsum('ID,kb,jb,ja->IakD', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvoV += 1/2 * lib.einsum('ID,kb,jlcb,jlca->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += 1/4 * lib.einsum('ID,kb,jlbc,jlac->IakD', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvoV -= 1/2 * lib.einsum('ID,jb,jlbc,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV -= 1/2 * lib.einsum('ID,jb,jlbc,klac->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV += 1/4 * lib.einsum('ID,ja,jlbc,klbc->IakD', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvoV += 1/2 * lib.einsum('ID,ja,jb,kb->IakD', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        OvoV += 1/2 * lib.einsum('ID,ja,ljbc,lkbc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= 1/2 * lib.einsum('ID,jb,jlbc,klac->IakD', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        OvoV -= 1/2 * lib.einsum('ID,jb,ljcb,lkca->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += 1/2 * lib.einsum('Ib,ka,jb,jD->IakD', Y_aa, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        OvoV += 1/4 * lib.einsum('Ib,ka,jlbc,jlDc->IakD', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OvoV += 1/2 * lib.einsum('Ib,ka,jlbc,jlDc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('Ib,kc,jlba,jlDc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('Ib,jb,jD,ka->IakD', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OvoV += lib.einsum('Ib,jb,jlDc,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('Ib,jb,jlDc,klac->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV -= lib.einsum('Ib,jc,lkba,jlDc->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvoV -= lib.einsum('Ib,ja,lkbc,ljDc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('Ib,jc,lkba,ljDc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += 1/4 * lib.einsum('ka,jD,jlbc,Ilbc->IakD', Y_bb, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OvoV += 1/2 * lib.einsum('ka,jD,jb,Ib->IakD', Y_bb, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        OvoV += 1/2 * lib.einsum('ka,jD,jlbc,Ilbc->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= 1/2 * lib.einsum('ka,jb,jlbc,IlDc->IakD', Y_bb, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        OvoV -= 1/2 * lib.einsum('ka,jb,jlbc,IlDc->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= 1/2 * lib.einsum('ka,jb,jlbc,IlDc->IakD', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvoV -= 1/2 * lib.einsum('ka,jb,ljcb,IlDc->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvoV -= lib.einsum('kb,jD,Ilcb,jlca->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('kb,jc,IlDb,jlca->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('kb,jb,ja,ID->IakD', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        OvoV += lib.einsum('kb,jb,jlac,IlDc->IakD', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('kb,jb,ljca,IlDc->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvoV -= lib.einsum('kb,jc,IlDb,jlac->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV += lib.einsum('jD,jb,Ib,ka->IakD', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OvoV += lib.einsum('jD,jb,Ilbc,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('jD,jb,Ilbc,klac->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV -= lib.einsum('jD,lb,jkca,Ilbc->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvoV -= lib.einsum('jD,la,jkbc,Ilbc->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('jD,lb,jkca,Ilcb->IakD', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('jb,jb,ID,ka->IakD', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        OvoV -= lib.einsum('jb,jb,IlDc,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('jb,jb,IlDc,klac->IakD', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV += lib.einsum('jb,jc,IlDb,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('jb,lb,IjDc,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('jb,lc,IjDb,lkca->IakD', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('jb,lc,IjDb,klac->IakD', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_bbbb, optimize = True)
        OvoV += lib.einsum('ja,jb,kb,ID->IakD', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        OvoV += lib.einsum('ja,jb,klbc,IlDc->IakD', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('ja,jb,lkcb,IlDc->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        OvoV += lib.einsum('ja,lb,IjDc,lkbc->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('ja,lb,IjDc,klbc->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV -= lib.einsum('jb,jb,ID,ka->IakD', Y_bb, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        OvoV -= lib.einsum('jb,jb,IlDc,lkca->IakD', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        OvoV -= lib.einsum('jb,jb,IlDc,klac->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV += lib.einsum('jb,jc,IlDb,klac->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV -= lib.einsum('jb,lc,IjDb,lkca->IakD', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        OvoV += lib.einsum('jb,lb,IjDc,klac->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        OvoV -= lib.einsum('jb,lc,IjDb,klac->IakD', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)

        oVOv =- lib.einsum('KA,id->iAKd', Y_aa, Y_bb, optimize = True)
        oVOv -= lib.einsum('KjAb,jibd->iAKd', Y_aaaa, Y_abab, optimize = True)
        oVOv -= lib.einsum('KjAb,ijdb->iAKd', Y_abab, Y_bbbb, optimize = True)
        oVOv -= lib.einsum('KA,ijdb,jb->iAKd', t1_ce_aa, Y_bbbb, Y_bb, optimize = True)
        oVOv -= lib.einsum('KA,jibd,jb->iAKd', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        oVOv += lib.einsum('jA,jibd,Kb->iAKd', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        oVOv += lib.einsum('Kb,jibd,jA->iAKd', t1_ce_aa, Y_abab, Y_aa, optimize = True)
        oVOv -= lib.einsum('id,KjAb,jb->iAKd', t1_ce_bb, Y_aaaa, Y_aa, optimize = True)
        oVOv -= lib.einsum('id,KjAb,jb->iAKd', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        oVOv += lib.einsum('jd,KjAb,ib->iAKd', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        oVOv += lib.einsum('ib,KjAb,jd->iAKd', t1_ce_bb, Y_abab, Y_bb, optimize = True)
        oVOv += 1/2 * lib.einsum('KA,ib,jb,jd->iAKd', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        oVOv += 1/2 * lib.einsum('KA,ib,jlcb,jlcd->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += 1/4 * lib.einsum('KA,ib,jlbc,jldc->iAKd', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        oVOv -= 1/2 * lib.einsum('KA,jb,jlbc,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv -= 1/2 * lib.einsum('KA,jb,jlbc,ildc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv += 1/4 * lib.einsum('KA,jd,jlbc,ilbc->iAKd', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        oVOv += 1/2 * lib.einsum('KA,jd,jb,ib->iAKd', Y_aa, Y_bb, t1_ce_bb, t1_ce_bb, optimize = True)
        oVOv += 1/2 * lib.einsum('KA,jd,ljbc,libc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= 1/2 * lib.einsum('KA,jb,jlbc,ildc->iAKd', Y_aa, Y_bb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = True)
        oVOv -= 1/2 * lib.einsum('KA,jb,ljcb,licd->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += 1/2 * lib.einsum('Kb,id,jb,jA->iAKd', Y_aa, Y_bb, t1_ce_aa, t1_ce_aa, optimize = True)
        oVOv += 1/4 * lib.einsum('Kb,id,jlbc,jlAc->iAKd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVOv += 1/2 * lib.einsum('Kb,id,jlbc,jlAc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('Kb,ic,jlbd,jlAc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('Kb,jb,jA,id->iAKd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        oVOv += lib.einsum('Kb,jb,jlAc,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('Kb,jb,jlAc,ildc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv -= lib.einsum('Kb,jc,libd,jlAc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVOv -= lib.einsum('Kb,jd,libc,ljAc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('Kb,jc,libd,ljAc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += 1/4 * lib.einsum('id,jA,jlbc,Klbc->iAKd', Y_bb, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVOv += 1/2 * lib.einsum('id,jA,jb,Kb->iAKd', Y_bb, Y_aa, t1_ce_aa, t1_ce_aa, optimize = True)
        oVOv += 1/2 * lib.einsum('id,jA,jlbc,Klbc->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= 1/2 * lib.einsum('id,jb,jlbc,KlAc->iAKd', Y_bb, Y_aa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = True)
        oVOv -= 1/2 * lib.einsum('id,jb,jlbc,KlAc->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= 1/2 * lib.einsum('id,jb,jlbc,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        oVOv -= 1/2 * lib.einsum('id,jb,ljcb,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVOv -= lib.einsum('ib,jA,Klcb,jlcd->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('ib,jc,KlAb,jlcd->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('ib,jb,jd,KA->iAKd', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        oVOv += lib.einsum('ib,jb,jldc,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('ib,jb,ljcd,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVOv -= lib.einsum('ib,jc,KlAb,jldc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv += lib.einsum('jA,jb,Kb,id->iAKd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        oVOv += lib.einsum('jA,jb,Klbc,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('jA,jb,Klbc,ildc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv -= lib.einsum('jA,lb,jicd,Klbc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVOv -= lib.einsum('jA,ld,jibc,Klbc->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('jA,lb,jicd,Klcb->iAKd', Y_aa, Y_bb, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jb,jb,KA,id->iAKd', Y_aa, Y_aa, t1_ce_aa, t1_ce_bb, optimize = True)
        oVOv -= lib.einsum('jb,jb,KlAc,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jb,jb,KlAc,ildc->iAKd', Y_aa, Y_aa, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv += lib.einsum('jb,jc,KlAb,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('jb,lb,KjAc,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jb,lc,KjAb,licd->iAKd', Y_aa, Y_aa, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jb,lc,KjAb,ildc->iAKd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ccee_bbbb, optimize = True)
        oVOv += lib.einsum('jd,jb,ib,KA->iAKd', Y_bb, Y_bb, t1_ce_bb, t1_ce_aa, optimize = True)
        oVOv += lib.einsum('jd,jb,ilbc,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_bbbb, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('jd,jb,licb,KlAc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_aaaa, optimize = True)
        oVOv += lib.einsum('jd,lb,KjAc,libc->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jd,lb,KjAc,ilbc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv -= lib.einsum('jb,jb,KA,id->iAKd', Y_bb, Y_bb, t1_ce_aa, t1_ce_bb, optimize = True)
        oVOv -= lib.einsum('jb,jb,KlAc,licd->iAKd', Y_bb, Y_bb, t1_ccee_aaaa, t1_ccee_abab, optimize = True)
        oVOv -= lib.einsum('jb,jb,KlAc,ildc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv += lib.einsum('jb,jc,KlAb,ildc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv -= lib.einsum('jb,lc,KjAb,licd->iAKd', Y_bb, Y_aa, t1_ccee_abab, t1_ccee_abab, optimize = True)
        oVOv += lib.einsum('jb,lb,KjAc,ildc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        oVOv -= lib.einsum('jb,lc,KjAb,ildc->iAKd', Y_bb, Y_bb, t1_ccee_abab, t1_ccee_bbbb, optimize = True)
        
        OooO = -OoOo.transpose(0,1,3,2)
        VvvV = -VvVv.transpose(0,1,3,2)
        OovV = -OoVv.transpose(0,1,3,2)
        VvoO = -VvOo.transpose(0,1,3,2)

        OvvO_1 = -OvOv.transpose(0,1,3,2)
        VooV_2 = -oVoV.transpose(1,0,2,3)
        VovO_3 = oVOv.transpose(1,0,3,2)

        spin = 0.25*((na - nb)**2) + 0.5*(na + nb) + np.einsum('pr,qs,pqrs->',delta[:nocc_a,:nocc_b], delta[:nocc_a,:nocc_b].T, OooO, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[nocc_a:,nocc_b:], delta[nocc_a:,nocc_b:].T, VvvV, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[:nocc_a,nocc_b:], delta[nocc_a:,:nocc_b].T, OovV, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[nocc_a:,:nocc_b], delta[:nocc_a,nocc_b:].T,VvoO, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[:nocc_a,nocc_b:], delta[:nocc_a,nocc_b:].T,OvvO_1, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[nocc_a:,:nocc_b], delta[nocc_a:,:nocc_b].T,VooV_2, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[:nocc_a,:nocc_b], delta[nocc_a:,nocc_b:].T,OvoV, optimize = True)
        spin += np.einsum('pr,qs,pqrs->', delta[nocc_a:,nocc_b:], delta[:nocc_a,:nocc_b:].T,VovO_3, optimize = True)
         

        print("spin contamination", spin)
     ...
     #   norm = np.linalg.norm(temp_2ab - temp_2ab.transpose(2,3,0,1))
     #   print("Total TPDM  Hermiticity",norm)
     #   norm = np.linalg.norm(temp_2ab + temp_2ab.transpose(1,0,2,3))
     #   print("Total TPDM bra symmetry",norm)
     #   norm = np.linalg.norm(temp_2ab + temp_2ab.transpose(0,1,3,2))
     #   print("Total TPDM ket symmetry",norm)
     #   print("TPDM trace",np.einsum('pqpq',temp_2ab))
     #   spin = 0

     #   norm = np.linalg.norm(tpdm - tpdm.transpose(2,3,0,1))
     #   print("Total TPDM  Hermiticity",norm)
     #   norm = np.linalg.norm(tpdm + tpdm.transpose(1,0,2,3))
     #   print("Total TPDM bra symmetry",norm)
     #   norm = np.linalg.norm(tpdm + tpdm.transpose(0,1,3,2))
     #   print("Total TPDM ket symmetry",norm)
     #   print("TPDM trace",np.einsum('pqpq',tpdm))
     #   spin = 0

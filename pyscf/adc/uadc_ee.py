...
#TPDM ADC(2)
        ...
        if adc.opdm is True:
            ...
            temp_2a[:nocc_a,nocc_a:,nocc_a:,:nocc_a] = -temp.tranpose(0,1,3,2)
            temp_2a[nocc_a:,:nocc_a,nocc_a:,:nocc_a] = temp.tranpose(1,0,3,2)
            temp_2a[nocc_a:,:nocc_a,:nocc_a,nocc_a:] = -temp.tranpose(1,0,2,3)
            ...
            temp_2b[:nocc_b,nocc_b:,nocc_b:,:nocc_b] = -temp.tranpose(0,1,3,2)
            temp_2b[nocc_b:,:nocc_b,nocc_b:,:nocc_b] = temp.tranpose(1,0,3,2)
            temp_2b[nocc_b:,:nocc_b,:nocc_b,nocc_b:] = -temp.tranpose(1,0,2,3)

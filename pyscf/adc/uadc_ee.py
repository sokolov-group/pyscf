...
#    #M^(2)_0 term 3 iemf
    ...
    if (method == "adc(3)"):
            ...
            #M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('bcef,jibe,jlcf->il',  v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            #M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('adbc,jb,jc->da',  v_eeee_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            #M_030_bb[occ_list_b,:,occ_list_b,:] += 1/2 * lib.einsum('adbc,jkbe,jkce->da',  v_eeee_bbaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            #M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('adbc,jkbe,jkce->da',  v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            #M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('abce,jkeb,jkcd->da',  v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            #M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('dbce,jkeb,jkca->da',  v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
...
#
#
#                    temp_[a:a+k] -= einsum('AaDb,Ia,Lb->IDLA', v_eeee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
#                    temp_[a:a+k] -= einsum('AaDb,Iiac,Libc->IDLA', v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] -= einsum('AaDb,Iiac,Libc->IDLA', v_eeee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
#                    temp_[a:a+k] += 1/2 * einsum('Aabc,IiDa,Libc->IDLA', v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] += 1/2 * einsum('Dabc,LiAa,Iibc->IDLA', v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] += einsum('IL,AaDb,ia,ib->IDLA', np.identity(ncore), v_eeee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
#                    temp_[a:a+k] += 1/2 * einsum('IL,AaDb,ijac,ijbc->IDLA', np.identity(ncore), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] += einsum('IL,AaDb,ijac,ijbc->IDLA', np.identity(ncore), v_eeee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
#                    temp_[a:a+k] -= 1/4 * einsum('AD,abcd,Iiab,Licd->IDLA', np.identity(nextern), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] -= 1/4 * einsum('IL,Aabc,ijDa,ijbc->IDLA', np.identity(ncore), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#                    temp_[a:a+k] -= 1/4 * einsum('IL,Dabc,ijAa,ijbc->IDLA', np.identity(ncore), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
#
#                    del eris_vvvv
#                    a += k
#                M_ia_jb_a  += temp
...
#                M_ia_jb_a  += temp
            ...
            if isinstance(eris.vVvV_p,np.ndarray):
                ...
                #M_030_bb -= einsum('abdc,jibe,jlce->idla', v_eeee_baba, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                M_030_bb -= lib.einsum('bacd,jibe,jlce->idla', v_eeee_abab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                #M_030_bb -= einsum('abce,jibd,jlce->idla', v_eeee_baab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                ...
                #M_030_bb += 1/2 * einsum('il,abdc,jkbe,jkce->idla', np.identity(ncore), v_eeee_baba, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
                ...
                #M_030_bb += einsum('il,abdc,jb,jc->idla', np.identity(ncore), v_eeee_baba, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
                M_030_bb += lib.einsum('il,bacd,jb,jc->idla', np.identity(ncore_b), v_eeee_abab, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
                #M_030_bb += einsum('il,abdc,jkbe,jkce->idla', np.identity(ncore), v_eeee_baba, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                ...
                #M_030_bb += einsum('il,abce,jkbd,jkce->idla', np.identity(ncore), v_eeee_baab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                ...
                #M_030_bb -= einsum('dbce,jlba,jice->idla', v_eeee_baab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                M_030_bb += lib.einsum('bdce,jlba,jice->idla', v_eeee_abab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
                #M_030_bb += einsum('il,dbce,jkba,jkce->idla', np.identity(ncore), v_eeee_baab, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
...
#M_030_bb -= einsum('abdc,ib,lc->idla', v_eeee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
#M_030_bb -= einsum('abdc,ijbe,ljce->idla', v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
#M_030_bb -= einsum('abdc,jieb,jlec->idla', v_eeee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
#M_030_bb += 1/2 * einsum('abce,ijdb,ljce->idla', v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
#M_030_bb += 1/2 * einsum('dbce,ljab,ijce->idla', v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
#M_030_bb -= 1/4 * einsum('ad,bcef,ijbc,ljef->idla', np.identity(nextern), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)

#M_030_bb += einsum('il,abdc,jb,jc->idla', np.identity(ncore), v_eeee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
#M_030_bb += einsum('il,abdc,jkeb,jkec->idla', np.identity(ncore), v_eeee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
#M_030_bb += 1/2 * einsum('il,abdc,jkbe,jkce->idla', np.identity(ncore), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)

#M_030_bb -= 1/4 * einsum('il,abce,jkdb,jkce->idla', np.identity(ncore), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
#M_030_bb -= 1/4 * einsum('il,dbce,jkab,jkce->idla', np.identity(ncore), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Iiab,Laib->IL', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Iiab,Laib->IL', t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Liab,Iaib->IL', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Liab,Iaib->IL', t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('ia,ILia->IL',t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ia,iILa->IL',t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('ia,LIia->IL',t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ia,iLIa->IL',t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('ia,ILia->IL',t2_ce_bb, v_ccce_aabb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('ia,LIia->IL',t2_ce_bb, v_ccce_aabb, optimize = einsum_type)

            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('ijAa,iDja->DA',t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('ijDa,iAja->DA',t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('ijAa,iDja->DA',t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('ijDa,iAja->DA',t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ia,iaDA->DA',t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('ILia,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('ILia,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('LIia,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('LIia,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('ILia,ijab,jb->IL',  v_ccce_aabb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('ILia,jiba,jb->IL',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('LIia,ijab,jb->IL',  v_ccce_aabb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('LIia,jiba,jb->IL',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Iija,ib,Ljab->IL',  v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iILa,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iILa,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('iIja,ijab,Lb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Iija,ib,Ljba->IL',  v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iIja,ijba,Lb->IL',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Iiab,ijca,Ljcb->IL',  v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iLIa,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iLIa,ijab,jb->IL',  v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ijIa,Liab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Iaib,La,ib->IL',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Iaib,ia,Lb->IL',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ijIa,Liab,jb->IL',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Iaib,La,ib->IL',  v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Lija,ib,Ijab->IL',  v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= 1/2 * lib.einsum('iLja,ijab,Ib->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Lija,ib,Ijba->IL',  v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += 1/2 * lib.einsum('iLja,ijba,Ib->IL',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Liab,ijca,Ijcb->IL',  v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ijLa,Iiab,jb->IL',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Laib,Ia,ib->IL',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('Laib,ia,Ib->IL',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[:,vir_list_a,:,vir_list_a] += lib.einsum('ijLa,Iiab,jb->IL',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[:,vir_list_a,:,vir_list_a] -= lib.einsum('Laib,Ia,ib->IL',  v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijkA,kiDa,ja->DA',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] -= 1/2 * lib.einsum('iADa,ijab,jb->DA',  v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= 1/2 * lib.einsum('iADa,ijab,jb->DA',  v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iAja,iD,ja->DA',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('iAja,ia,jD->DA',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iAab,ijDb,ja->DA',  v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijkA,kiDa,ja->DA',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iAja,iD,ja->DA',  v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijkD,kiAa,ja->DA',  v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iDja,iA,ja->DA',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('iDja,ia,jA->DA',  v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iDab,ijAb,ja->DA',  v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijkD,kiAa,ja->DA',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] -= lib.einsum('iDja,iA,ja->DA',  v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijka,jA,ikDa->DA',  v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijka,jD,ikAa->DA',  v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            ...
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijka,jA,ikDa->DA',  v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa[occ_list_a,:,occ_list_a,:] += lib.einsum('ijka,jD,ikAa->DA',  v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
...
########################################################################################################################################################################
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ijbc,lbjc->il', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ljbc,ibjc->il', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jibc,lcjb->il', t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jlbc,icjb->il', t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jb,iljb->il', t2_ce_aa, v_ccce_bbaa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jb,lijb->il', t2_ce_aa, v_ccce_bbaa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jb,iljb->il', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jb,jilb->il', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('jb,lijb->il', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jb,jlib->il', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)

            M_030_bb[occ_list_b,:,occ_list_b] += lib.einsum('jb,jbad->da',  t2_ce_aa, v_ceee_aabb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b] -= lib.einsum('jkba,kdjb->da',t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b] -= lib.einsum('jkbd,kajb->da',t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b] += lib.einsum('jb,jbda->da',  t2_ce_aa, v_ceee_aabb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b] -= lib.einsum('jkab,jdkb->da', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b] -= lib.einsum('jkdb,jakb->da', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('iljk,jmbc,kmbc->il',  v_cccc_bbaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('iljk,jb,kb->il',  v_cccc_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('iljk,jmbc,kmbc->il',  v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('iljb,jkbc,kc->il',  v_ccce_bbaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('iljb,jkbc,kc->il',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('lijb,jkbc,kc->il',  v_ccce_bbaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('lijb,jkbc,kc->il',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('iljb,jkbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('iljb,kjcb,kc->il',  v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('lijb,jkbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('lijb,kjcb,kc->il',  v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ijkm,mjbc,klbc->il',  v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('ijkb,jc,klbc->il',  v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jikb,kjbc,lc->il',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ijkb,jc,lkbc->il',  v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jilb,jkbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jilb,kjcb,kc->il',  v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('jikb,jkbc,lc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jkib,jlcb,kc->il',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ibjc,lb,jc->il',  v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jlib,jkbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jlib,kjcb,kc->il',  v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jkib,ljbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ibjc,lb,jc->il',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('ibjc,jb,lc->il',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ljkm,mjbc,kibc->il',  v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('ljkb,jc,kibc->il',  v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += 1/2 * lib.einsum('jlkb,kjbc,ic->il',  v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('ljkb,jc,ikbc->il',  v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= 1/2 * lib.einsum('jlkb,jkbc,ic->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jklb,jicb,kc->il',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('lbjc,ib,jc->il',  v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('jklb,ijbc,kc->il',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] -= lib.einsum('lbjc,ib,jc->il',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[:,vir_list_b,:,vir_list_b] += lib.einsum('lbjc,jb,ic->il',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkma,jmbd,kb->da',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('jakb,jd,kb->da',  v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkma,mjdb,kb->da',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('jakb,jd,kb->da',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jakb,jb,kd->da',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmd,jmba,kb->da',  v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('jdkb,ja,kb->da',  v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('jdbc,kjca,kb->da',  v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmd,mjab,kb->da',  v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] -= lib.einsum('jdkb,ja,kb->da',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jdkb,jb,ka->da',  v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmb,ka,mjbd->da',  v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmb,kd,mjba->da',  v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmb,ka,jmdb->da',  v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb[occ_list_b,:,occ_list_b,:] += lib.einsum('jkmb,kd,jmab->da',  v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)

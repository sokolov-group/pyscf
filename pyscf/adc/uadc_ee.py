...
#    #M^(2)_0 term 3 iemf
    ...
    if (method == "adc(3)"):
            ...
            v_cccc_aaaa = eris.oooo.copy()
            v_cccc_bbbb = eris.OOOO.copy()
            v_cccc_aabb = eris.ooOO.copy()
            v_cccc_bbaa = eris.OOoo.copy()
            
            v_eeee_aaaa = eris.vvvv.copy()
            v_eeee_bbbb = eris.VVVV.copy()
            v_eeee_aabb = eris.vvVV.copy()
            v_eeee_bbaa = eris.VVvv.copy()

            v_ceec_aaaa = eris.ovvo.copy()
            v_ceec_bbbb = eris.OVVO.copy()
            v_ceec_aabb = eris.ovVO.copy()
            v_ceec_bbaa = eris.OVvo.copy()
            
            v_cece_aaaa = eris.ovvo.transpose(0,1,3,2).copy()
            v_cece_bbbb = eris.OVVO.transpose(0,1,3,2).copy()
            v_cece_aabb = eris.ovVO.transpose(0,1,3,2).copy()
            v_cece_bbaa = eris.OVvo.transpose(0,1,3,2).copy()
            
            v_ccee_aaaa = eris.oovv.copy()
            v_ccee_bbbb = eris.OOVV.copy()
            v_ccee_aabb = eris.ooVV.copy()
            v_ccee_bbaa = eris.OOvv.copy()

            #v_ccce_aaaa = eris.ovoo.transpose(2,3,0,1).copy()
            #v_ccce_bbbb = eris.OVOO.transpose(2,3,0,1).copy()
            #v_ccce_bbaa = eris.ovOO.transpose(2,3,0,1).copy()
            #v_ccce_aabb = eris.OVoo.transpose(2,3,0,1).copy()

            v_ccce_aaaa = eris.ooov.copy()
            v_ccce_bbbb = eris.OOOV.copy()
            v_ccce_bbaa = eris.OOov.copy()
            v_ccce_aabb = eris.ooOV.copy()
            ...
            M_030_aa =- lib.einsum('iA,iLID->IDLA', t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('iA,ILiD->IDLA', t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('iD,iILA->IDLA', t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('iD,LIiA->IDLA', t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IiDa,LAia->IDLA', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IiDa,iALa->IDLA', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('Ia,LaDA->IDLA', t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('Ia,LADa->IDLA', t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IiDa,LAia->IDLA', t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa += lib.einsum('LiAa,IDia->IDLA', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('LiAa,iDIa->IDLA', t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            ...
            M_030_aa += lib.einsum('LiAa,IDia->IDLA', t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('iA,IL,iD->IDLA', h_ce_aa, np.identity(ncore_a), t2_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('iD,IL,iA->IDLA', h_ce_aa, np.identity(ncore_a), t2_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('Ia,AD,La->IDLA', h_ce_aa, np.identity(nextern_a), t2_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('La,AD,Ia->IDLA', h_ce_aa, np.identity(nextern_a), t2_ce_aa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('AD,Iiab,Laib->IDLA', np.identity(nextern_a), t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iiab,Laib->IDLA', np.identity(nextern_a), t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Liab,Iaib->IDLA', np.identity(nextern_a), t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Liab,Iaib->IDLA', np.identity(nextern_a), t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ia,ILia->IDLA', np.identity(nextern_a), t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ia,iILa->IDLA', np.identity(nextern_a), t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ia,LIia->IDLA', np.identity(nextern_a), t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ia,iLIa->IDLA', np.identity(nextern_a), t2_ce_aa, v_ccce_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ia,ILia->IDLA', np.identity(nextern_a), t2_ce_bb, v_ccce_aabb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ia,LIia->IDLA', np.identity(nextern_a), t2_ce_bb, v_ccce_aabb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAa,iDja->IDLA', np.identity(ncore_a), t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijDa,iAja->IDLA', np.identity(ncore_a), t2_ccee_aaaa, v_cece_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ia,iaAD->IDLA', np.identity(ncore_a), t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ia,iADa->IDLA', np.identity(ncore_a), t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAa,iDja->IDLA', np.identity(ncore_a), t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijDa,iAja->IDLA', np.identity(ncore_a), t2_ccee_abab, v_cece_aabb, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ia,iaDA->IDLA', np.identity(ncore_a), t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ia,iDAa->IDLA', np.identity(ncore_a), t2_ce_aa, v_ceee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ia,iaAD->IDLA', np.identity(ncore_a), t2_ce_bb, v_ceee_bbaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ia,iaDA->IDLA', np.identity(ncore_a), t2_ce_bb, v_ceee_bbaa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('ADab,Iica,Licb->IDLA', v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iILA,ijDa,ja->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iILA,ijDa,ja->IDLA', v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('ijLA,ja,IiDa->IDLA', v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LAai,ijab,IjDb->IDLA', v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LAai,ijab,IjDb->IDLA', v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LADa,Iiab,ib->IDLA', v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LADa,Iiab,ib->IDLA', v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('LAia,Ia,iD->IDLA', v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('LAab,IiDb,ia->IDLA', v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('ijLA,ja,IiDa->IDLA', v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aa += 1/2 * lib.einsum('LIiA,ijDa,ja->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LIiA,ijDa,ja->IDLA', v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iIjA,jiDa,La->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa += lib.einsum('LijA,IjDa,ia->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('iAaj,IiDb,Ljab->IDLA', v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iADa,Iiab,Lb->IDLA', v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('iALa,iD,Ia->IDLA', v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa += lib.einsum('Aabc,Liac,IiDb->IDLA', v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iLID,ijAa,ja->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iLID,ijAa,ja->IDLA', v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('ijID,ja,LiAa->IDLA', v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('IDia,La,iA->IDLA', v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IDab,LiAb,ia->IDLA', v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('ijID,ja,LiAa->IDLA', v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aa += 1/2 * lib.einsum('ILiD,ijAa,ja->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('ILiD,ijAa,ja->IDLA', v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iLjD,jiAa,Ia->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa += lib.einsum('IijD,LjAa,ia->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('iDaj,LiAb,Ijab->IDLA', v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('iDIa,iA,La->IDLA', v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('iDab,LiAb,Ia->IDLA', v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa += lib.einsum('Dabc,Iiac,LiAb->IDLA', v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aa -= 1/2 * lib.einsum('ILia,ijAa,jD->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('LIia,ijDa,jA->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa += 1/2 * lib.einsum('ILia,jiAa,jD->IDLA', v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('LIia,jiDa,jA->IDLA', v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('Iija,iD,LjAa->IDLA', v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('iILa,ijDa,jA->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('Iija,iD,LjAa->IDLA', v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('Iiab,ijDa,LjAb->IDLA', v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('iLIa,ijAa,jD->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('ijIa,LiAa,jD->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('Lija,iA,IjDa->IDLA', v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            ...
            M_030_aa -= lib.einsum('Lija,iA,IjDa->IDLA', v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('Liab,ijAa,IjDb->IDLA', v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('ijLa,IiDa,jA->IDLA', v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aa -= 1/2 * lib.einsum('A,IL,iA,iD->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('A,IL,iD,iA->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/4 * lib.einsum('A,IL,ijAa,ijDa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/4 * lib.einsum('A,IL,ijDa,ijAa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('A,IL,ijAa,ijDa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('A,IL,ijDa,ijAa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('D,IL,iA,iD->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('D,IL,iD,iA->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/4 * lib.einsum('D,IL,ijAa,ijDa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/4 * lib.einsum('D,IL,ijDa,ijAa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('D,IL,ijAa,ijDa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('D,IL,ijDa,ijAa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/4 * lib.einsum('I,AD,Iiab,Liab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('I,AD,Ia,La->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('I,AD,Iiab,Liab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/4 * lib.einsum('I,AD,Liab,Iiab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('I,AD,La,Ia->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('I,AD,Liab,Iiab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/4 * lib.einsum('L,AD,Iiab,Liab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('L,AD,Ia,La->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('L,AD,Iiab,Liab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/4 * lib.einsum('L,AD,Liab,Iiab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('L,AD,La,Ia->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('L,AD,Liab,Iiab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('i,AD,Iiab,Liab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('i,AD,Liab,Iiab->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,iA,iD->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,iD,iA->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,ijAa,ijDa->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,ijDa,ijAa->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,ijAa,ijDa->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,ijDa,ijAa->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Ia,La->IDLA', e_extern_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Iiab,Liab->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Iiab,Liab->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,La,Ia->IDLA', e_extern_a, np.identity(nextern_a), t1_ce_aa, t2_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Liab,Iiab->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Liab,Iiab->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('a,IL,ijAa,ijDa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('a,IL,ijDa,ijAa->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t2_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('i,AD,Iiab,Liab->IDLA', e_core_b, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('i,AD,Liab,Iiab->IDLA', e_core_b, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,jiAa,jiDa->IDLA', e_core_b, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('i,IL,jiDa,jiAa->IDLA', e_core_b, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Iiba,Liba->IDLA', e_extern_b, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,AD,Liba,Iiba->IDLA', e_extern_b, np.identity(nextern_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,IL,ijAa,ijDa->IDLA', e_extern_b, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('a,IL,ijDa,ijAa->IDLA', e_extern_b, np.identity(ncore_a), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            ...
            M_030_aa -= 1/2 * lib.einsum('iA,IL,ijDa,ja->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iA,IL,ijDa,ja->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iD,IL,ijAa,ja->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('iD,IL,ijAa,ja->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('Ia,AD,Liab,ib->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('Ia,AD,Liab,ib->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('La,AD,Iiab,ib->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('La,AD,Iiab,ib->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('ia,AD,Iiab,Lb->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('ia,AD,Liab,Ib->IDLA', h_ce_aa, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('ia,IL,ijAa,jD->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('ia,IL,ijDa,jA->IDLA', h_ce_aa, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('ia,AD,Iiba,Lb->IDLA', h_ce_bb, np.identity(nextern_a), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('ia,AD,Liba,Ib->IDLA', h_ce_bb, np.identity(nextern_a), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('ia,IL,jiAa,jD->IDLA', h_ce_bb, np.identity(ncore_a), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('ia,IL,jiDa,jA->IDLA', h_ce_bb, np.identity(ncore_a), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,ILij,ikab,jkab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ILij,ia,ja->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ILij,ikab,jkab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,LIia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,LIia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ILab,ia,ib->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILab,ijac,ijbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ILab,ijac,ijbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,ILij,ikab,jkab->IDLA', np.identity(nextern_a), v_cccc_aabb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ILij,ia,ja->IDLA', np.identity(nextern_a), v_cccc_aabb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ILij,kiab,kjab->IDLA', np.identity(nextern_a), v_cccc_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILia,jiba,jb->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,LIia,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,LIia,jiba,jb->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ILab,ia,ib->IDLA', np.identity(nextern_a), v_ccee_aabb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,ILab,ijca,ijcb->IDLA', np.identity(nextern_a), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,ILab,ijac,ijbc->IDLA', np.identity(nextern_a), v_ccee_aabb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,IijL,ikab,jkab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,IijL,ia,ja->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,IijL,ikab,jkab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,Iijk,ikab,Ljab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iija,ib,Ljab->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iILa,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iILa,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,iIja,ijab,Lb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iiab,ia,Lb->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iiab,ijac,Ljbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iiab,ijac,Ljbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iijk,ikab,Ljab->IDLA', np.identity(nextern_a), v_cccc_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iija,ib,Ljba->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iIja,ijba,Lb->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iiab,ijca,Ljcb->IDLA', np.identity(nextern_a), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iLIa,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iLIa,ijab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijIa,Liab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iaib,La,ib->IDLA', np.identity(nextern_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Iaib,ia,Lb->IDLA', np.identity(nextern_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,IabL,ia,ib->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,IabL,ijac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,IabL,ijac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,La,ib->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,Ljac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,Ljac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabc,Liac,ib->IDLA', np.identity(nextern_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijIa,Liab,jb->IDLA', np.identity(nextern_a), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iaib,La,ib->IDLA', np.identity(nextern_a), v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,La,ib->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,Ljac,jicb->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabi,Ljac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ccee_abab, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Iabc,Liac,ib->IDLA', np.identity(nextern_a), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,Lijk,ikab,Ijab->IDLA', np.identity(nextern_a), v_cccc_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Lija,ib,Ijab->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,iLja,ijab,Ib->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Liab,ia,Ib->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Liab,ijac,Ijbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Liab,ijac,Ijbc->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Lijk,ikab,Ijab->IDLA', np.identity(nextern_a), v_cccc_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Lija,ib,Ijba->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('AD,iLja,ijba,Ib->IDLA', np.identity(nextern_a), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Liab,ijca,Ijcb->IDLA', np.identity(nextern_a), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijLa,Iiab,jb->IDLA', np.identity(nextern_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Laib,Ia,ib->IDLA', np.identity(nextern_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,Laib,ia,Ib->IDLA', np.identity(nextern_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ia,ib->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ijac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ijac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labc,Iiac,ib->IDLA', np.identity(nextern_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijLa,Iiab,jb->IDLA', np.identity(nextern_a), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Laib,Ia,ib->IDLA', np.identity(nextern_a), v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ia,ib->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ijac,jicb->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labi,Ijac,ijbc->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ccee_abab, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,Labc,Iiac,ib->IDLA', np.identity(nextern_a), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijab,Iibc,Ljac->IDLA', np.identity(nextern_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,iabj,Iiac,Ljbc->IDLA', np.identity(nextern_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,iabc,Iiac,Lb->IDLA', np.identity(nextern_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,iabj,Iiac,Ljcb->IDLA', np.identity(nextern_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,iabc,Ib,Lica->IDLA', np.identity(nextern_a), v_ceee_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('AD,abcd,Iiac,Libd->IDLA', np.identity(nextern_a), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,iabc,Ib,Lica->IDLA', np.identity(nextern_a), v_ceee_bbaa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,abcd,Iiac,Libd->IDLA', np.identity(nextern_a), v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijab,Iibc,Ljac->IDLA', np.identity(nextern_a), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,ijab,Iicb,Ljca->IDLA', np.identity(nextern_a), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('AD,iabj,Iica,Ljbc->IDLA', np.identity(nextern_a), v_ceec_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,iabc,Iica,Lb->IDLA', np.identity(nextern_a), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('AD,iabj,Iica,Ljcb->IDLA', np.identity(nextern_a), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,ijAD,ikab,jkab->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAD,ia,ja->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAD,ikab,jkab->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaAD,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaAD,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaDA,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaDA,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ADab,ia,ib->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,ADab,ijac,ijbc->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ADab,ijac,ijbc->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,ijAD,ikab,jkab->IDLA', np.identity(ncore_a), v_ccee_bbaa, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAD,ia,ja->IDLA', np.identity(ncore_a), v_ccee_bbaa, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijAD,kiab,kjab->IDLA', np.identity(ncore_a), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaAD,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaAD,jiba,jb->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaDA,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaDA,jiba,jb->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ADab,ia,ib->IDLA', np.identity(ncore_a), v_eeee_aabb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ADab,ijca,ijcb->IDLA', np.identity(ncore_a), v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,ADab,ijac,ijbc->IDLA', np.identity(ncore_a), v_eeee_aabb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iADj,ikab,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iADj,ia,ja->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iADj,ikab,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijkA,kiDa,ja->IDLA', np.identity(ncore_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,iD,ja->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,ikDb,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,ikDb,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iADa,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iADa,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAja,iD,ja->IDLA', np.identity(ncore_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iAja,ia,jD->IDLA', np.identity(ncore_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAab,ijDb,ja->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijkA,kiDa,ja->IDLA', np.identity(ncore_a), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,iD,ja->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,ikDb,kjba->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAaj,ikDb,jkab->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_abab, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAja,iD,ja->IDLA', np.identity(ncore_a), v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iAab,ijDb,ja->IDLA', np.identity(ncore_a), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iDAa,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iDAa,ijab,jb->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijAa,ia,jD->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijAa,ikab,jkDb->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijAa,ikab,jkDb->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaAb,ijba,jD->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,AabD,ia,ib->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,AabD,ijac,ijbc->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,AabD,ijac,ijbc->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iabA,jb,ijDa->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,Aabc,ijac,ijDb->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijAa,kiab,kjDb->IDLA', np.identity(ncore_a), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iaAb,jiba,jD->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iabA,jb,jiDa->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,Aabc,ijac,ijDb->IDLA', np.identity(ncore_a), v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijkD,kiAa,ja->IDLA', np.identity(ncore_a), v_ccce_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,iA,ja->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,ikAb,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,ikAb,jkab->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDja,iA,ja->IDLA', np.identity(ncore_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iDja,ia,jA->IDLA', np.identity(ncore_a), v_cece_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDab,ijAb,ja->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijkD,kiAa,ja->IDLA', np.identity(ncore_a), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,iA,ja->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,ikAb,kjba->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDaj,ikAb,jkab->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_abab, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDja,iA,ja->IDLA', np.identity(ncore_a), v_cece_aabb, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iDab,ijAb,ja->IDLA', np.identity(ncore_a), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijDa,ia,jA->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijDa,ikab,jkAb->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijDa,ikab,jkAb->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += 1/2 * lib.einsum('IL,iaDb,ijba,jA->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iabD,jb,ijAa->IDLA', np.identity(ncore_a), v_ceee_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,Dabc,ijac,ijAb->IDLA', np.identity(ncore_a), v_eeee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijDa,kiab,kjAb->IDLA', np.identity(ncore_a), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,iaDb,jiba,jA->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iabD,jb,jiAa->IDLA', np.identity(ncore_a), v_ceee_bbaa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,Dabc,ijac,ijAb->IDLA', np.identity(ncore_a), v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 1/2 * lib.einsum('IL,ijkl,ikAa,jlDa->IDLA', np.identity(ncore_a), v_cccc_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijka,jA,ikDa->IDLA', np.identity(ncore_a), v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijka,jD,ikAa->IDLA', np.identity(ncore_a), v_ccce_aaaa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijab,ikAb,jkDa->IDLA', np.identity(ncore_a), v_ccee_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,ijkl,ikAa,jlDa->IDLA', np.identity(ncore_a), v_cccc_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijka,jA,ikDa->IDLA', np.identity(ncore_a), v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijka,jD,ikAa->IDLA', np.identity(ncore_a), v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijab,ikAb,jkDa->IDLA', np.identity(ncore_a), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iabj,ikAa,jkDb->IDLA', np.identity(ncore_a), v_ceec_aaaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iabj,ikAa,kjDb->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,iabj,ikDa,kjAb->IDLA', np.identity(ncore_a), v_ceec_aabb, t1_ccee_aaaa, t1_ccee_abab, optimize = einsum_type)
            M_030_aa += lib.einsum('IL,ijab,kiAb,kjDa->IDLA', np.identity(ncore_a), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= lib.einsum('IL,iabj,kiAa,kjDb->IDLA', np.identity(ncore_a), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('A,IL,iA,ijDa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('A,IL,iA,ijDa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('A,IL,iD,ijAa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('A,IL,iD,ijAa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('D,IL,iA,ijDa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('D,IL,iA,ijDa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('D,IL,iD,ijAa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('D,IL,iD,ijAa,ja->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('I,AD,Iiab,La,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('I,AD,Ia,Liab,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('I,AD,Ia,Liab,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('I,AD,Iiab,La,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('L,AD,Iiab,La,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('L,AD,Ia,Liab,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('L,AD,Ia,Liab,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('L,AD,Iiab,La,ib->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('i,AD,Iiab,ia,Lb->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('i,AD,Liab,ia,Ib->IDLA', e_core_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('i,AD,ia,Iiab,Lb->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('i,AD,ia,Liab,Ib->IDLA', e_core_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('i,IL,iD,ijAa,ja->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('i,IL,iD,ijAa,ja->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('i,IL,ijAa,ia,jD->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('i,IL,ijDa,iA,ja->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.333333334 * lib.einsum('i,IL,ijDa,ia,jA->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('i,IL,ia,ijAa,jD->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.166666667 * lib.einsum('i,IL,ia,ijDa,jA->IDLA', e_core_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('i,IL,ijDa,iA,ja->IDLA', e_core_a, np.identity(ncore_a), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,La,Iiab,ib->IDLA', e_extern_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,La,Iiab,ib->IDLA', e_extern_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,Liab,Ia,ib->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('a,AD,Liab,ia,Ib->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,Liab,Ia,ib->IDLA', e_extern_a, np.identity(nextern_a), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('a,AD,ia,Iiab,Lb->IDLA', e_extern_a, np.identity(nextern_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('a,IL,ia,ijDa,jA->IDLA', e_extern_a, np.identity(ncore_a), t1_ce_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.500000001 * lib.einsum('a,IL,ijAa,ia,jD->IDLA', e_extern_a, np.identity(ncore_a), t1_ccee_aaaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('i,AD,Iiab,ib,La->IDLA', e_core_b, np.identity(nextern_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('i,AD,Liab,ib,Ia->IDLA', e_core_b, np.identity(nextern_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('i,AD,ia,Iiba,Lb->IDLA', e_core_b, np.identity(nextern_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('i,AD,ia,Liba,Ib->IDLA', e_core_b, np.identity(nextern_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('i,IL,ia,jiAa,jD->IDLA', e_core_b, np.identity(ncore_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.166666667 * lib.einsum('i,IL,ia,jiDa,jA->IDLA', e_core_b, np.identity(ncore_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('i,IL,jiAa,ia,jD->IDLA', e_core_b, np.identity(ncore_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_aa += 0.333333334 * lib.einsum('i,IL,jiDa,ia,jA->IDLA', e_core_b, np.identity(ncore_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,Liba,ia,Ib->IDLA', e_extern_b, np.identity(nextern_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,AD,ia,Iiba,Lb->IDLA', e_extern_b, np.identity(nextern_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,IL,ia,jiDa,jA->IDLA', e_extern_b, np.identity(ncore_a), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aa -= 0.500000001 * lib.einsum('a,IL,ijAa,ja,iD->IDLA', e_extern_b, np.identity(ncore_a), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            
            M_030_bb =- lib.einsum('ja,jlid->idla', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ja,iljd->idla', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('jd,jila->idla', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('jd,lija->idla', t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ijdb,lajb->idla', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ijdb,jalb->idla', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('ljab,idjb->idla', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ljab,jdib->idla', t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('jibd,lajb->idla', t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb += lib.einsum('jlba,idjb->idla', t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('ja,il,jd->idla', h_ce_bb, np.identity(ncore_b), t2_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('jd,il,ja->idla', h_ce_bb, np.identity(ncore_b), t2_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ib,ad,lb->idla', h_ce_bb, np.identity(nextern_b), t2_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('lb,ad,ib->idla', h_ce_bb, np.identity(nextern_b), t2_ce_bb, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('ad,ijbc,lbjc->idla', np.identity(nextern_b), t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ljbc,ibjc->idla', np.identity(nextern_b), t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jibc,lcjb->idla', np.identity(nextern_b), t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jlbc,icjb->idla', np.identity(nextern_b), t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jb,iljb->idla', np.identity(nextern_b), t2_ce_aa, v_ccce_bbaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jb,lijb->idla', np.identity(nextern_b), t2_ce_aa, v_ccce_bbaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jb,iljb->idla', np.identity(nextern_b), t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jb,jilb->idla', np.identity(nextern_b), t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jb,lijb->idla', np.identity(nextern_b), t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jb,jlib->idla', np.identity(nextern_b), t2_ce_bb, v_ccce_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jb,jbad->idla', np.identity(ncore_b), t2_ce_aa, v_ceee_aabb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkba,kdjb->idla', np.identity(ncore_b), t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkbd,kajb->idla', np.identity(ncore_b), t2_ccee_abab, v_cece_bbaa, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jb,jbda->idla', np.identity(ncore_b), t2_ce_aa, v_ceee_aabb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkab,jdkb->idla', np.identity(ncore_b), t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkdb,jakb->idla', np.identity(ncore_b), t2_ccee_bbbb, v_cece_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jb,jbad->idla', np.identity(ncore_b), t2_ce_bb, v_ceee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jb,jadb->idla', np.identity(ncore_b), t2_ce_bb, v_ceee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jb,jbda->idla', np.identity(ncore_b), t2_ce_bb, v_ceee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jb,jdab->idla', np.identity(ncore_b), t2_ce_bb, v_ceee_bbbb, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('adbc,jibe,jlce->idla', v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= 1/2 * lib.einsum('jila,jkdb,kb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jila,kjbd,kb->idla', v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('jkla,kb,jibd->idla', v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('jkla,kb,ijdb->idla', v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('lajb,ib,jd->idla', v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += 1/2 * lib.einsum('lija,jkdb,kb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('lija,kjbd,kb->idla', v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jika,kjdb,lb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('ljka,ikdb,jb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('jalb,jd,ib->idla', v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('abce,jleb,jicd->idla', v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= 1/2 * lib.einsum('jlid,jkab,kb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jlid,kjba,kb->idla', v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('jkid,kb,jlba->idla', v_ccce_aabb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('jkid,kb,ljab->idla', v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('idjb,lb,ja->idla', v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('idbc,ljac,jb->idla', v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('iljd,jkab,kb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('iljd,kjba,kb->idla', v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jlkd,kjab,ib->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('ijkd,lkab,jb->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('jdbk,ljac,ikbc->idla', v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('jdib,ja,lb->idla', v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('dbce,jieb,jlca->idla', v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('iljk,jmba,kmbd->idla', v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('iljb,jkba,kd->idla', v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('lijb,jkbd,ka->idla', v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb -= 1/2 * lib.einsum('iljb,jkab,kd->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('lijb,jkdb,ka->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ilbc,jkdb,jkac->idla', v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ijkm,mjbd,klba->idla', v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ijkb,jd,klba->idla', v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('ijkb,jd,lkab->idla', v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('jilb,jkdb,ka->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += 1/2 * lib.einsum('jlib,jkab,kd->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('jkib,ljab,kd->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('ljkm,mjba,kibd->idla', v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ljkb,ja,kibd->idla', v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_bb -= lib.einsum('ljkb,ja,ikdb->idla', v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_bb += lib.einsum('jklb,ijdb,ka->idla', v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_bb -= 1/2 * lib.einsum('a,il,ja,jd->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('a,il,jd,ja->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('a,il,jkba,jkbd->idla', e_extern_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('a,il,jkbd,jkba->idla', e_extern_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/4 * lib.einsum('a,il,jkab,jkdb->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/4 * lib.einsum('a,il,jkdb,jkab->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('d,il,ja,jd->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('d,il,jd,ja->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('d,il,jkba,jkbd->idla', e_extern_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('d,il,jkbd,jkba->idla', e_extern_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/4 * lib.einsum('d,il,jkab,jkdb->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/4 * lib.einsum('d,il,jkdb,jkab->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/4 * lib.einsum('i,ad,ijbc,ljbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('i,ad,ib,lb->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += 1/4 * lib.einsum('i,ad,ljbc,ijbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('i,ad,lb,ib->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('i,ad,jibc,jlbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('i,ad,jlbc,jibc->idla', e_core_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/4 * lib.einsum('l,ad,ijbc,ljbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('l,ad,ib,lb->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += 1/4 * lib.einsum('l,ad,ljbc,ijbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('l,ad,lb,ib->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('l,ad,jibc,jlbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('l,ad,jlbc,jibc->idla', e_core_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('j,ad,jibc,jlbc->idla', e_core_a, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('j,ad,jlbc,jibc->idla', e_core_a, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,jkba,jkbd->idla', e_core_a, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,jkbd,jkba->idla', e_core_a, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,jibc,jlbc->idla', e_extern_a, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,jlbc,jibc->idla', e_extern_a, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,il,jkba,jkbd->idla', e_extern_a, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,il,jkbd,jkba->idla', e_extern_a, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('j,ad,ijbc,ljbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('j,ad,ljbc,ijbc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,ja,jd->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,jd,ja->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,jkab,jkdb->idla', e_core_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,jkdb,jkab->idla', e_core_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,kjba,kjbd->idla', e_core_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('j,il,kjbd,kjba->idla', e_core_b, np.identity(ncore_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,ib,lb->idla', e_extern_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,ijbc,ljbc->idla', e_extern_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,lb,ib->idla', e_extern_b, np.identity(nextern_b), t1_ce_bb, t2_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,ljbc,ijbc->idla', e_extern_b, np.identity(nextern_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,jicb,jlcb->idla', e_extern_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('b,ad,jlcb,jicb->idla', e_extern_b, np.identity(nextern_b), t1_ccee_abab, t2_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('b,il,jkab,jkdb->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('b,il,jkdb,jkab->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t2_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_bb -= 1/2 * lib.einsum('ja,il,jkdb,kb->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ja,il,kjbd,kb->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jd,il,jkab,kb->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jd,il,kjba,kb->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ib,ad,ljbc,jc->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ib,ad,jlcb,jc->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('lb,ad,ijbc,jc->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('lb,ad,jicb,jc->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jb,ad,jibc,lc->idla', h_ce_aa, np.identity(nextern_b), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jb,ad,jlbc,ic->idla', h_ce_aa, np.identity(nextern_b), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jb,il,jkba,kd->idla', h_ce_aa, np.identity(ncore_b), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('jb,il,jkbd,ka->idla', h_ce_aa, np.identity(ncore_b), t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('jb,ad,ijbc,lc->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('jb,ad,ljbc,ic->idla', h_ce_bb, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('jb,il,jkab,kd->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('jb,il,jkdb,ka->idla', h_ce_bb, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,iljk,jmbc,kmbc->idla', np.identity(nextern_b), v_cccc_bbaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,iljk,jb,kb->idla', np.identity(nextern_b), v_cccc_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,iljk,jmbc,kmbc->idla', np.identity(nextern_b), v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,iljb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,iljb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,lijb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,lijb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ilbc,jb,jc->idla', np.identity(nextern_b), v_ccee_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,ilbc,jkbe,jkce->idla', np.identity(nextern_b), v_ccee_bbaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ilbc,jkbe,jkce->idla', np.identity(nextern_b), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,iljk,jmbc,kmbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,iljk,jb,kb->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,iljk,mjbc,mkbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,iljb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,iljb,kjcb,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,lijb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,lijb,kjcb,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ilbc,jb,jc->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ilbc,jkeb,jkec->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,ilbc,jkbe,jkce->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ijkm,mjbc,klbc->idla', np.identity(nextern_b), v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ijkb,jc,klbc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jikb,kjbc,lc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ijbc,kjbe,klce->idla', np.identity(nextern_b), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,ijkl,jmbc,kmbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ijkl,jb,kb->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ijkl,mjbc,mkbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,ijkm,jmbc,lkbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ijkb,jc,lkbc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jilb,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jilb,kjcb,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,jikb,jkbc,lc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ijbc,jb,lc->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ijbc,jkbe,lkce->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ijbc,kjeb,klec->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jkib,jlcb,kc->idla', np.identity(nextern_b), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibjc,lb,jc->idla', np.identity(nextern_b), v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,lb,jc->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,lkbe,jkce->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,kleb,jkce->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibce,jleb,jc->idla', np.identity(nextern_b), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jlib,jkbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jlib,kjcb,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jkib,ljbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibjc,lb,jc->idla', np.identity(nextern_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ibjc,jb,lc->idla', np.identity(nextern_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ibcl,jb,jc->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ibcl,jkeb,jkec->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,ibcl,jkbe,jkce->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,lb,jc->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,lkbe,jkce->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibcj,kleb,kjec->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ibce,ljbe,jc->idla', np.identity(nextern_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ljkm,mjbc,kibc->idla', np.identity(nextern_b), v_cccc_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ljkb,jc,kibc->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('ad,jlkb,kjbc,ic->idla', np.identity(nextern_b), v_ccce_bbaa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ljbc,kjbe,kice->idla', np.identity(nextern_b), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,ljkm,jmbc,ikbc->idla', np.identity(nextern_b), v_cccc_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,ljkb,jc,ikbc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,jlkb,jkbc,ic->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ljbc,jb,ic->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ljbc,jkbe,ikce->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,ljbc,kjeb,kiec->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jklb,jicb,kc->idla', np.identity(nextern_b), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbjc,ib,jc->idla', np.identity(nextern_b), v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,ib,jc->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,ikbe,jkce->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,kieb,jkce->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbce,jieb,jc->idla', np.identity(nextern_b), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jklb,ijbc,kc->idla', np.identity(nextern_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbjc,ib,jc->idla', np.identity(nextern_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,lbjc,jb,ic->idla', np.identity(nextern_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,ib,jc->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,ikbe,jkce->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbcj,kieb,kjec->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,lbce,ijbe,jc->idla', np.identity(nextern_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jkbc,jice,klbe->idla', np.identity(nextern_b), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jkbc,jiec,kleb->idla', np.identity(nextern_b), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jbck,jibe,klce->idla', np.identity(nextern_b), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,bcef,jibe,jlcf->idla', np.identity(nextern_b), v_eeee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jkbc,ijce,lkbe->idla', np.identity(nextern_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jbck,ijbe,klce->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jbck,ljbe,kice->idla', np.identity(nextern_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jbck,ijbe,lkce->idla', np.identity(nextern_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('ad,jbce,ijbe,lc->idla', np.identity(nextern_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jbce,ic,jlbe->idla', np.identity(nextern_b), v_ceee_aabb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jbce,lc,jibe->idla', np.identity(nextern_b), v_ceee_aabb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('ad,jbce,ic,ljeb->idla', np.identity(nextern_b), v_ceee_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('ad,bcef,ijbe,ljcf->idla', np.identity(nextern_b), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jkad,jmbc,kmbc->idla', np.identity(ncore_b), v_ccee_aabb, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkad,jb,kb->idla', np.identity(ncore_b), v_ccee_aabb, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkad,jmbc,kmbc->idla', np.identity(ncore_b), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbad,jkbc,kc->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbad,jkbc,kc->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbda,jkbc,kc->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbda,jkbc,kc->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,adbc,jb,jc->idla', np.identity(ncore_b), v_eeee_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,adbc,jkbe,jkce->idla', np.identity(ncore_b), v_eeee_bbaa, t1_ccee_aaaa, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb += lib.einsum('il,adbc,jkbe,jkce->idla', np.identity(ncore_b), v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jkad,jmbc,kmbc->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkad,jb,kb->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkad,mjbc,mkbc->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbad,jkbc,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbad,kjcb,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbda,jkbc,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbda,kjcb,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('il,adbc,jb,jc->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,adbc,jkeb,jkec->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,adbc,jkbe,jkce->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkma,jmbd,kb->idla', np.identity(ncore_b), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,jd,kb->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,jmdc,kmbc->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,mjcd,kmbc->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jakb,jd,kb->idla', np.identity(ncore_b), v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabc,kjcd,kb->idla', np.identity(ncore_b), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jadk,jmbc,kmbc->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jadk,jb,kb->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jadk,mjbc,mkbc->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkma,mjdb,kb->idla', np.identity(ncore_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,jd,kb->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,jmdc,kmbc->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabk,mjcd,mkcb->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jadb,jkbc,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jadb,kjcb,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jakb,jd,kb->idla', np.identity(ncore_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jakb,jb,kd->idla', np.identity(ncore_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jabc,jkdc,kb->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkab,jmcb,kmcd->idla', np.identity(ncore_b), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jbac,jkbc,kd->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jbca,kc,jkbd->idla', np.identity(ncore_b), v_ceee_aabb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,abce,jkeb,jkcd->idla', np.identity(ncore_b), v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jdab,jkbc,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jdab,kjcb,kc->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkab,jb,kd->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkab,jmbc,kmdc->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkab,mjcb,mkcd->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbac,jkcb,kd->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,abcd,jb,jc->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,abcd,jkeb,jkec->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,abcd,jkbe,jkce->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jbca,kc,jkdb->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,abce,jkbe,jkdc->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmd,jmba,kb->idla', np.identity(ncore_b), v_ccce_aabb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,ja,kb->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,jmac,kmbc->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,mjca,kmbc->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdkb,ja,kb->idla', np.identity(ncore_b), v_cece_bbaa, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbc,kjca,kb->idla', np.identity(ncore_b), v_ceee_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmd,mjab,kb->idla', np.identity(ncore_b), v_ccce_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,ja,kb->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,jmac,kmbc->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbk,mjca,mkcb->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdkb,ja,kb->idla', np.identity(ncore_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jdkb,jb,ka->idla', np.identity(ncore_b), v_cece_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jdbc,jkac,kb->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkdb,jmcb,kmca->idla', np.identity(ncore_b), v_ccee_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jbdc,jkbc,ka->idla', np.identity(ncore_b), v_ceee_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jbcd,kc,jkba->idla', np.identity(ncore_b), v_ceee_aabb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,dbce,jkeb,jkca->idla', np.identity(ncore_b), v_eeee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkdb,jb,ka->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkdb,jmbc,kmac->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkdb,mjcb,mkca->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += 1/2 * lib.einsum('il,jbdc,jkcb,ka->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jbcd,kc,jkab->idla', np.identity(ncore_b), v_ceee_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,dbce,jkbe,jkac->idla', np.identity(ncore_b), v_eeee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkbc,jmca,kmbd->idla', np.identity(ncore_b), v_ccee_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jkmn,jmba,knbd->idla', np.identity(ncore_b), v_cccc_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jbck,jmba,kmcd->idla', np.identity(ncore_b), v_ceec_aaaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmb,ka,mjbd->idla', np.identity(ncore_b), v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmb,kd,mjba->idla', np.identity(ncore_b), v_ccce_bbaa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkbc,mjca,mkbd->idla', np.identity(ncore_b), v_ccee_bbaa, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= 1/2 * lib.einsum('il,jkmn,jmab,kndb->idla', np.identity(ncore_b), v_cccc_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmb,ka,jmdb->idla', np.identity(ncore_b), v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkmb,kd,jmab->idla', np.identity(ncore_b), v_ccce_bbbb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jkbc,jmac,kmdb->idla', np.identity(ncore_b), v_ccee_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jbck,jmab,kmcd->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb += lib.einsum('il,jbck,jmdb,kmca->idla', np.identity(ncore_b), v_ceec_bbaa, t1_ccee_bbbb, t1_ccee_abab, optimize = einsum_type)
            M_030_bb -= lib.einsum('il,jbck,jmab,kmdc->idla', np.identity(ncore_b), v_ceec_bbbb, t1_ccee_bbbb, t1_ccee_bbbb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('a,il,ja,jkdb,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('a,il,ja,kjbd,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('a,il,jd,jkab,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('a,il,jd,kjba,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('d,il,ja,jkdb,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('d,il,ja,kjbd,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('d,il,jd,jkab,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('d,il,jd,kjba,kb->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('i,ad,ijbc,lb,jc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('i,ad,ib,ljbc,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('i,ad,ib,jlcb,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('i,ad,lb,jicb,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('l,ad,ijbc,lb,jc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('l,ad,ib,ljbc,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('l,ad,ib,jlcb,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('l,ad,lb,jicb,jc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('j,ad,jibc,jb,lc->idla', e_core_a, np.identity(nextern_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('j,ad,jlbc,jb,ic->idla', e_core_a, np.identity(nextern_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('j,ad,jb,jibc,lc->idla', e_core_a, np.identity(nextern_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('j,ad,jb,jlbc,ic->idla', e_core_a, np.identity(nextern_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('j,il,jb,jkba,kd->idla', e_core_a, np.identity(ncore_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.166666667 * lib.einsum('j,il,jb,jkbd,ka->idla', e_core_a, np.identity(ncore_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('j,il,jkba,jb,kd->idla', e_core_a, np.identity(ncore_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.333333334 * lib.einsum('j,il,jkbd,jb,ka->idla', e_core_a, np.identity(ncore_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,jb,jibc,lc->idla', e_extern_a, np.identity(nextern_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,jlbc,jb,ic->idla', e_extern_a, np.identity(nextern_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,il,jb,jkbd,ka->idla', e_extern_a, np.identity(ncore_b), t1_ce_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,il,jkba,jb,kd->idla', e_extern_a, np.identity(ncore_b), t1_ccee_abab, t1_ce_aa, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('j,ad,ijbc,jb,lc->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('j,ad,ljbc,jb,ic->idla', e_core_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('j,ad,jb,ijbc,lc->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('j,ad,jb,ljbc,ic->idla', e_core_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('j,il,jd,jkab,kb->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('j,il,jd,kjba,kb->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('j,il,jkab,jb,kd->idla', e_core_b, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('j,il,jkdb,ja,kb->idla', e_core_b, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.333333334 * lib.einsum('j,il,jkdb,jb,ka->idla', e_core_b, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('j,il,jb,jkab,kd->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.166666667 * lib.einsum('j,il,jb,jkdb,ka->idla', e_core_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('j,il,kjbd,ja,kb->idla', e_core_b, np.identity(ncore_b), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,lb,ijbc,jc->idla', e_extern_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,lb,jicb,jc->idla', e_extern_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,ljbc,ib,jc->idla', e_extern_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('b,ad,ljbc,jb,ic->idla', e_extern_b, np.identity(nextern_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('b,ad,jb,ijbc,lc->idla', e_extern_b, np.identity(nextern_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb -= 0.500000001 * lib.einsum('b,ad,jlcb,ib,jc->idla', e_extern_b, np.identity(nextern_b), t1_ccee_abab, t1_ce_bb, t1_ce_aa, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('b,il,jb,jkdb,ka->idla', e_extern_b, np.identity(ncore_b), t1_ce_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_bb += 0.500000001 * lib.einsum('b,il,jkab,jb,kd->idla', e_extern_b, np.identity(ncore_b), t1_ccee_bbbb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            
            
            M_030_aabb =- lib.einsum('iD,iIla->IDla', t2_ce_aa, v_ccce_aabb, optimize = einsum_type)
            M_030_aabb += lib.einsum('IiDb,laib->IDla', t2_ccee_aaaa, v_cece_bbaa, optimize = einsum_type)
            M_030_aabb += lib.einsum('Ib,laDb->IDla', t2_ce_aa, v_ceee_bbaa, optimize = einsum_type)
            M_030_aabb += lib.einsum('IiDb,laib->IDla', t2_ccee_abab, v_cece_bbbb, optimize = einsum_type)
            M_030_aabb -= lib.einsum('IiDb,ialb->IDla', t2_ccee_abab, v_cece_bbbb, optimize = einsum_type)
            M_030_aabb -= lib.einsum('ia,ilID->IDla', t2_ce_bb, v_ccce_bbaa, optimize = einsum_type)
            M_030_aabb += lib.einsum('liab,IDib->IDla', t2_ccee_bbbb, v_cece_aabb, optimize = einsum_type)
            M_030_aabb += lib.einsum('lb,IDab->IDla', t2_ce_bb, v_ceee_aabb, optimize = einsum_type)
            M_030_aabb += lib.einsum('ilba,IDib->IDla', t2_ccee_abab, v_cece_aaaa, optimize = einsum_type)
            M_030_aabb -= lib.einsum('ilba,iDIb->IDla', t2_ccee_abab, v_cece_aaaa, optimize = einsum_type)
            ...
            M_030_aabb -= 1/2 * lib.einsum('ilID,ijab,jb->IDla', v_ccce_bbaa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
            M_030_aabb -= 1/2 * lib.einsum('ilID,jiba,jb->IDla', v_ccce_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('ijID,jb,ilba->IDla', v_ccce_aaaa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('ijID,jb,liab->IDla', v_ccce_bbaa, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('IDib,lb,ia->IDla', v_cece_aabb, t1_ce_bb, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aabb += 1/2 * lib.einsum('iljD,jiba,Ib->IDla', v_ccce_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aabb += lib.einsum('iDbl,ijca,Ijcb->IDla', v_ceec_aabb, t1_ccee_abab, t1_ccee_abab, optimize = einsum_type)
            M_030_aabb += lib.einsum('IijD,jlba,ib->IDla', v_ccce_aaaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aabb -= 1/2 * lib.einsum('iIla,ijDb,jb->IDla', v_ccce_aabb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aabb -= 1/2 * lib.einsum('iIla,ijDb,jb->IDla', v_ccce_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            M_030_aabb += 1/2 * lib.einsum('iIja,ijDb,lb->IDla', v_ccce_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('Iijb,iD,jlba->IDla', v_ccce_aaaa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('Iijb,iD,ljab->IDla', v_ccce_aabb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
            M_030_aabb += 1/2 * lib.einsum('iIlb,ijDb,ja->IDla', v_ccce_aabb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aabb += lib.einsum('ijIb,ilba,jD->IDla', v_ccce_aaaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            M_030_aabb += lib.einsum('Ibci,jlba,ijDc->IDla', v_ceec_aaaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aabb += 1/2 * lib.einsum('ilIb,jiba,jD->IDla', v_ccce_bbaa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('ijla,jb,IiDb->IDla', v_ccce_aabb, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('laib,Ib,iD->IDla', v_cece_bbaa, t1_ce_aa, t1_ce_aa, optimize = einsum_type)
            M_030_aabb += lib.einsum('labc,IiDc,ib->IDla', v_ceee_bbaa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
            M_030_aabb -= lib.einsum('ijla,jb,IiDb->IDla', v_ccce_bbbb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aabb += lib.einsum('lija,IjDb,ib->IDla', v_ccce_bbbb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
            ...
            M_030_aabb += lib.einsum('lijk,kiba,IjDb->IDla', v_cccc_bbaa, t1_ccee_abab, t1_ccee_aaaa, optimize = einsum_type)
            M_030_aabb -= lib.einsum('lijb,ia,IjDb->IDla', v_ccce_bbaa, t1_ce_bb, t1_ccee_aaaa, optimize = einsum_type)
            ...
            M_030_aabb -= lib.einsum('lijb,ia,IjDb->IDla', v_ccce_bbbb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
            ...
            M_030_aabb += lib.einsum('ijlb,IiDb,ja->IDla', v_ccce_bbbb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
...
#        print("norm of s after", np.linalg.norm(s))
        ...
        if (method == "adc(3)"):
            ...
            M_12Y0_aa += lib.einsum('Ia,ia,JCiD->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('Ia,ia,iCJD->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('Ia,ijCD,iJja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa -= lib.einsum('Ja,ia,ICiD->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('Ja,ia,iCID->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('Ja,ijCD,iIja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa += lib.einsum('iC,IjDa,iJja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('iC,IjDa,jJia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa += lib.einsum('iC,IjDa,iJja->IJCD', Y_aa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('iC,JjDa,iIja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('iC,JjDa,jIia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa -= lib.einsum('iC,JjDa,iIja->IJCD', Y_aa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('iC,ia,IDJa->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('iC,ia,JDIa->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa -= lib.einsum('iD,IjCa,iJja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('iD,IjCa,jJia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa -= lib.einsum('iD,IjCa,iJja->IJCD', Y_aa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('iD,JjCa,iIja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('iD,JjCa,jIia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa += lib.einsum('iD,JjCa,iIja->IJCD', Y_aa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('iD,ia,ICJa->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('iD,ia,JCIa->IJCD', Y_aa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            ...
            M_12Y0_aa += lib.einsum('ia,IjCD,iJja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('ia,IjCD,jJia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa -= lib.einsum('ia,JjCD,iIja->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('ia,JjCD,jIia->IJCD', Y_aa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('ia,ka,jckd->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('ia,ka,kcjd->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('ia,klcd,kjla->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('ja,ka,ickd->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('ja,ka,kcid->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('ja,klcd,kila->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('kc,ilda,kjla->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('kc,ilda,ljka->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('kc,jlda,kila->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('kc,jlda,lika->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('kc,ka,idja->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('kc,ka,jdia->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('kc,liad,kjla->ijcd', Y_bb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('kc,ljad,kila->ijcd', Y_bb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('kd,ilca,kjla->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('kd,ilca,ljka->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('kd,jlca,kila->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('kd,jlca,lika->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('kd,ka,icja->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('kd,ka,jcia->ijcd', Y_bb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('kd,liac,kjla->ijcd', Y_bb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('kd,ljac,kila->ijcd', Y_bb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_12Y0_bb += lib.einsum('ka,ilcd,kjla->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('ka,ilcd,ljka->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb -= lib.einsum('ka,jlcd,kila->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('ka,jlcd,lika->ijcd', Y_bb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_12Y0_bb -= lib.einsum('ka,ilcd,ljka->ijcd', Y_aa, t1_ccee_bbbb, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_bb += lib.einsum('ka,jlcd,lika->ijcd', Y_aa, t1_ccee_bbbb, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_12Y0_aa -= lib.einsum('ia,IjCD,jJia->IJCD', Y_bb, t1_ccee_aaaa, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_aa += lib.einsum('ia,JjCD,jIia->IJCD', Y_bb, t1_ccee_aaaa, v_ccce_aabb, optimize = einsum_type)
            ...
            M_12Y0_ab -= lib.einsum('Ia,ia,iCjd->IjCd', Y_aa, t1_ce_aa, v_cece_aabb, optimize = einsum_type)
            ...
            M_12Y0_ab += lib.einsum('Ia,ikCd,kjia->IjCd', Y_aa, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_12Y0_ab += lib.einsum('iC,Ikad,kjia->IjCd', Y_aa, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('iC,kd,Iijk->IjCd', Y_aa, t1_ce_bb, v_cccc_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('iC,jkda,iIka->IjCd', Y_aa, t1_ccee_bbbb, v_ccce_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('iC,ja,Iiad->IjCd', Y_aa, t1_ce_bb, v_ccee_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('iC,ia,Iajd->IjCd', Y_aa, t1_ce_aa, v_cece_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('iC,kjad,iIka->IjCd', Y_aa, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('iC,kjad,kIia->IjCd', Y_aa, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('ia,IjCb,iadb->IjCd', Y_aa, t1_ccee_abab, v_ceee_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('ia,Ijbd,ibCa->IjCd', Y_aa, t1_ccee_abab, v_ceee_aaaa, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('ia,Ijbd,iaCb->IjCd', Y_aa, t1_ccee_abab, v_ceee_aaaa, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('ia,IkCd,kjia->IjCd', Y_aa, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('ia,kjCd,iIka->IjCd', Y_aa, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('ia,kjCd,kIia->IjCd', Y_aa, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_12Y0_ab -= lib.einsum('ja,ia,ICid->IjCd', Y_bb, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('ja,ikCd,iIka->IjCd', Y_bb, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            ...
            M_12Y0_ab -= lib.einsum('id,IkCa,ijka->IjCd', Y_bb, t1_ccee_aaaa, v_ccce_bbaa, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('id,Ia,ijCa->IjCd', Y_bb, t1_ce_aa, v_ccee_bbaa, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('id,IkCa,ijka->IjCd', Y_bb, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('id,IkCa,kjia->IjCd', Y_bb, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('id,ja,ICai->IjCd', Y_bb, t1_ce_bb, v_ceec_aabb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('id,ia,ICja->IjCd', Y_bb, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            M_12Y0_ab += lib.einsum('id,kjCa,kIia->IjCd', Y_bb, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            ...
            M_12Y0_ab += lib.einsum('ia,IkCd,ijka->IjCd', Y_bb, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('ia,IkCd,kjia->IjCd', Y_bb, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_12Y0_ab -= lib.einsum('ia,kjCd,kIia->IjCd', Y_bb, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            ...
            M_02Y1_aa -= lib.einsum('IiDa,jkab,jikb->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iajb->ID', Y_aaaa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('IiDa,jb,ijba->ID', Y_aaaa, t1_ce_aa, v_ccee_aaaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('IiDa,jkab,jikb->ID', Y_aaaa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iabj->ID', Y_aaaa, t1_ce_aa, v_ceec_aaaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('IiDa,jb,ibja->ID', Y_aaaa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iajb->ID', Y_aaaa, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iabj->ID', Y_aaaa, t1_ce_bb, v_ceec_aabb, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('Iiab,jD,iajb->ID', Y_aaaa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            ...
            M_02Y1_aa += 1/2 * lib.einsum('Iiab,jkab,kijD->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('ijDa,Ib,iajb->ID', Y_aaaa, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_02Y1_aa -= 1/2 * lib.einsum('ijDa,ijbc,Ibac->ID', Y_aaaa, t1_ccee_aaaa, v_ceee_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('ijDa,ikab,Ijkb->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('ijDa,ikab,kjIb->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_02Y1_aa += lib.einsum('ijDa,ikab,Ijkb->ID', Y_aaaa, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            ...
            M_02Y1_aa -= 1/2 * lib.einsum('ijab,ikab,kjID->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa += 1/2 * lib.einsum('ijab,ikab,IjkD->ID', Y_aaaa, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_02Y1_bb += lib.einsum('ijda,kb,jakb->id', Y_bbbb, t1_ce_aa, v_cece_bbaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('ijda,klba,ljkb->id', Y_bbbb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('ijda,kb,jabk->id', Y_bbbb, t1_ce_aa, v_ceec_bbaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('ijda,klab,kjlb->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('ijda,kb,jakb->id', Y_bbbb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_02Y1_bb -= lib.einsum('ijda,kb,jbka->id', Y_bbbb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('ijab,kd,jakb->id', Y_bbbb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_02Y1_bb += 1/2 * lib.einsum('ijab,klab,ljkd->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jkda,ib,jakb->id', Y_bbbb, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_02Y1_bb -= 1/2 * lib.einsum('jkda,jkbc,ibac->id', Y_bbbb, t1_ccee_bbbb, v_ceee_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jkda,jlab,iklb->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkda,jlab,lkib->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_02Y1_bb += lib.einsum('jkda,ljba,iklb->id', Y_bbbb, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_02Y1_bb -= 1/2 * lib.einsum('jkab,jlab,lkid->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb += 1/2 * lib.einsum('jkab,jlab,ikld->id', Y_bbbb, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_02Y1_bb -= 1/2 * lib.einsum('jkab,jlab,lkid->id', Y_aaaa, t1_ccee_aaaa, v_ccce_aabb, optimize = einsum_type)
            
            M_02Y1_aa += 1/2 * lib.einsum('ijab,ijac,IDbc->ID', Y_bbbb, t1_ccee_bbbb, v_ceee_aabb, optimize = einsum_type)
            M_02Y1_aa -= 1/2 * lib.einsum('ijab,ikab,kjID->ID', Y_bbbb, t1_ccee_bbbb, v_ccce_bbaa, optimize = einsum_type)
            ...
            M_02Y1_aa += lib.einsum('IiDa,jb,iajb->ID', Y_abab, t1_ce_aa, v_cece_bbaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('IiDa,jkba,kijb->ID', Y_abab, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iabj->ID', Y_abab, t1_ce_aa, v_ceec_bbaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('IiDa,jkab,jikb->ID', Y_abab, t1_ccee_bbbb, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('IiDa,jb,iajb->ID', Y_abab, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            ...
            M_02Y1_aa -= lib.einsum('IiDa,jb,ibja->ID', Y_abab, t1_ce_bb, v_cece_bbbb, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('Iiab,jD,ibja->ID', Y_abab, t1_ce_aa, v_cece_bbaa, optimize = einsum_type)
            ...
            M_02Y1_aa += lib.einsum('Iiab,jkab,kijD->ID', Y_abab, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('ijDa,Ib,ibja->ID', Y_abab, t1_ce_aa, v_cece_aabb, optimize = einsum_type)
            ...
            M_02Y1_aa += lib.einsum('ijDa,ikba,kjIb->ID', Y_abab, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('ijDa,jkab,Iikb->ID', Y_abab, t1_ccee_bbbb, v_ccce_aabb, optimize = einsum_type)
            ...
            M_02Y1_aa -= lib.einsum('ijDa,kjba,Iikb->ID', Y_abab, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('ijDa,kjba,kiIb->ID', Y_abab, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_02Y1_aa -= lib.einsum('ijab,ikab,kjID->ID', Y_abab, t1_ccee_abab, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_aa -= lib.einsum('ijab,kjab,kiID->ID', Y_abab, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_aa += lib.einsum('ijab,kjab,IikD->ID', Y_abab, t1_ccee_abab, v_ccce_aaaa, optimize = einsum_type)
            ...
            M_02Y1_bb -= lib.einsum('jiad,klab,kjlb->id', Y_abab, t1_ccee_aaaa, v_ccce_aaaa, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jiad,kb,jakb->id', Y_abab, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jiad,kb,jkba->id', Y_abab, t1_ce_aa, v_ccee_aaaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jiad,klab,kjlb->id', Y_abab, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jiad,kb,jabk->id', Y_abab, t1_ce_aa, v_ceec_aaaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jiad,kb,jbka->id', Y_abab, t1_ce_aa, v_cece_aaaa, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jiad,kb,jakb->id', Y_abab, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jiad,kb,jabk->id', Y_abab, t1_ce_bb, v_ceec_aabb, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jiab,kd,jakb->id', Y_abab, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            ...
            M_02Y1_bb += lib.einsum('jiab,klab,kjld->id', Y_abab, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkad,ib,jakb->id', Y_abab, t1_ce_bb, v_cece_aabb, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkad,jkbc,icab->id', Y_abab, t1_ccee_abab, v_ceee_bbaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkad,jlab,iklb->id', Y_abab, t1_ccee_aaaa, v_ccce_bbaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkad,jb,ikab->id', Y_abab, t1_ce_aa, v_ccee_bbaa, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkad,jlab,iklb->id', Y_abab, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jkad,jlab,lkib->id', Y_abab, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            ...
            M_02Y1_bb += lib.einsum('jkad,lkab,ljib->id', Y_abab, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)
            ...
            M_02Y1_bb -= lib.einsum('jkab,jlab,lkid->id', Y_abab, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb += lib.einsum('jkab,jlab,ikld->id', Y_abab, t1_ccee_abab, v_ccce_bbbb, optimize = einsum_type)
            M_02Y1_bb -= lib.einsum('jkab,lkab,ljid->id', Y_abab, t1_ccee_abab, v_ccce_aabb, optimize = einsum_type)

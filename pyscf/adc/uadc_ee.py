...
# OPDM ADC(2)-X
        ...
        ncore = nocc_a
        IjdL =- einsum('ij,ia,jkab,kb', S_oo_ab, S_ov_ab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ia,kjba,kb', S_oo_ab, S_ov_ab, Y_abab, Y_aa, optimize = einsum_type)
        IjdL += einsum('ij,ka,ib,kjba', S_oo_ab, S_ov_ab, Y_aa, Y_abab, optimize = einsum_type)
        IjdL -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IjdL -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ia,jkab,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ia,jkab,lkcb,lc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,jkbc,la,klbc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
        IjdL += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IjdL -= einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ia,kjbc,la,klbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        IjdL += einsum('ij,ia,klba,jc,klbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,klab,jc,klbc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
        IjdL += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IjdL += einsum('ij,ka,jlab,ilcb,kc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IjdL += einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IjdL += einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ka,kjbc,ilbc,la', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ka,klba,ilbc,jc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ka,ljba,ilbc,kc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IjdL -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IjdL -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IjdL += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IjdL += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_ov_ab, t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,jb,kc,klca,lb', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,jb,kb,klac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,jb,kb,lkca,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,jb,kc,klac,lb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,kb,kc,ljba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,kb,lb,kjca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,ka,kb,jlbc,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,ka,kb,ljcb,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,ka,lb,ljbc,kc', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,ka,lb,jlbc,kc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,kb,kc,jlab,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ia,kb,lb,jkac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ka,ib,jc,klba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ka,ib,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjdL += 1/2 * einsum('ij,ka,ib,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ka,ib,kc,ljba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ka,ib,lb,kjca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjdL -= 1/2 * einsum('ij,ka,ib,la,kjbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjdL -= einsum('ij,ka,ja,lb,ic,klbc', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
        IjdL += einsum('ij,ka,ja,lb,ic,klcb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL -= einsum('ij,ka,jb,lb,ic,klca', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL -= einsum('ij,ka,kb,lb,ic,ljca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL += einsum('ij,ka,kb,lc,ib,ljca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL += einsum('ij,ka,kb,lc,ib,jlac', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
        IjdL += einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL -= einsum('ij,ka,lb,lc,ib,kjca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL -= einsum('ij,ka,la,lb,ic,kjcb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IjdL += einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)

#        IjLd  = einsum('Ijad,La->IjLd', Y_abab, Y_aa, optimize = einsum_type)
#        IjLd -= einsum('IL,jkda,ka->IjLd', np.identity(ncore), Y_bbbb, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('IL,kjad,ka->IjLd', np.identity(ncore), Y_abab, Y_aa, optimize = einsum_type)
#        IjLd += einsum('Ijad,Lkab,kb->IjLd', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjLd += einsum('Ijad,Lkab,kb->IjLd', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('Ijab,Lkab,kd->IjLd', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('Ikab,Lkab,jd->IjLd', t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
#        IjLd += einsum('Ia,La,jd->IjLd', t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('Ikad,Lkab,jb->IjLd', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd += einsum('Ikab,Lkab,jd->IjLd', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd += einsum('jd,Ia,La->IjLd', t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IjLd += einsum('jkda,Lkba,Ib->IjLd', t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
#        IjLd -= einsum('kjad,Lkab,Ib->IjLd', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjLd += einsum('Ia,La,jd->IjLd', t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
#        IjLd += einsum('jd,Ia,La->IjLd', t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('Ia,La,jkdb,kb->IjLd', Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('Ia,La,kjbd,kb->IjLd', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('Ia,Lb,ka,kjbd->IjLd', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjLd -= einsum('Ia,ka,kjbd,Lb->IjLd', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += einsum('Ia,kb,La,kjbd->IjLd', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjLd += einsum('Ia,kb,La,jkdb->IjLd', Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('La,jd,Ikab,kb->IjLd', Y_aa, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('La,jd,Ikab,kb->IjLd', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('La,jb,Ikad,kb->IjLd', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('La,ka,kb,Ijbd->IjLd', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('La,kd,Ijab,kb->IjLd', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjLd -= einsum('jd,ka,Ikab,Lb->IjLd', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjLd += einsum('jd,ka,Ikba,Lb->IjLd', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= einsum('ja,ka,Ikbd,Lb->IjLd', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += einsum('ka,ka,Ijbd,Lb->IjLd', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= einsum('ka,kb,Ijad,Lb->IjLd', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= einsum('kd,ka,Ijba,Lb->IjLd', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += einsum('ka,ka,Ijbd,Lb->IjLd', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= einsum('IL,jd,ka,ka->IjLd', np.identity(ncore), t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IjLd -= einsum('IL,jd,ka,ka->IjLd', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,kd,ka,ja->IjLd', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('IL,jkda,kmab,mb->IjLd', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('IL,jkda,mkba,mb->IjLd', np.identity(ncore), t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,jkab,kmab,md->IjLd', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,ja,ka,kd->IjLd', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('IL,kjad,kmab,mb->IjLd', np.identity(ncore), t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjLd -= einsum('IL,kjad,kmab,mb->IjLd', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,kjab,kmab,md->IjLd', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,kmad,kmab,jb->IjLd', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,kmda,kmab,jb->IjLd', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjLd -= einsum('IL,jd,ka,ka->IjLd', np.identity(ncore), t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IjLd -= einsum('IL,jd,ka,ka->IjLd', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,kd,ka,ja->IjLd', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd += einsum('IL,ja,ka,kd->IjLd', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ja,kb,ma,kmbd->IjLd', np.identity(ncore), Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ja,ka,kmdb,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ja,ka,mkbd,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,ja,kb,ma,kmdb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,ka,ka,jmdb,mb->IjLd', np.identity(ncore), Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,ka,ka,mjbd,mb->IjLd', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ka,kb,ma,mjbd->IjLd', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ka,ma,kjbd,mb->IjLd', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,kd,ka,jmab,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,kd,ka,mjba,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,kd,ma,kb,mjab->IjLd', np.identity(ncore), Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,kd,ma,kb,jmab->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,ka,ka,jmdb,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd -= 1/2 * einsum('IL,ka,ka,mjbd,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ka,kb,jmda,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjLd += 1/2 * einsum('IL,ka,ma,jkdb,mb->IjLd', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
       


        S_ov_ab = delta[nocc_a:,:nocc_b].copy()
        ncore = nocc_b
        IjlD =- einsum('ij,aj,ikab,kb', S_oo_ab, S_ov_ab, Y_aaaa, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ikab,kb', S_oo_ab, S_ov_ab, Y_abab, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,ikab,jb', S_oo_ab, S_ov_ab, Y_abab, Y_bb, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ia,kb,kb', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ia,kb,kb', S_oo_ab, S_ov_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ikab,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ikab,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,ikbc,la,klbc', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_aa, Y_aaaa, optimize = einsum_type)
        IjlD += einsum('ij,aj,ib,ka,kb', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ikab,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ikab,lkcb,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IjlD += einsum('ij,aj,ikbc,la,lkbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        IjlD += einsum('ij,aj,ka,ib,kb', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,klab,ic,klbc', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_aa, Y_aaaa, optimize = einsum_type)
        IjlD += einsum('ij,aj,klab,ic,klcb', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        IjlD += einsum('ij,ak,ia,jb,kb', S_oo_ab, S_ov_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,ikab,jlbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,ikab,ljcb,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,ak,ikbc,ljbc,la', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IjlD += einsum('ij,ak,ilab,ljbc,kc', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        IjlD -= einsum('ij,ak,ilab,jlbc,kc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,klbc,ia,jlbc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_aa, Y_bbbb, optimize = einsum_type)
        IjlD += einsum('ij,ak,kb,ia,jb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
        IjlD -= einsum('ij,ak,lkab,ic,ljcb', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        IjlD += einsum('ij,ak,lkbc,ia,ljbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ia,kb,kb', S_oo_ab, S_ov_ab, t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD -= einsum('ij,aj,ia,kb,kb', S_oo_ab, S_ov_ab, t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,aj,ib,ka,kb', S_oo_ab, S_ov_ab, t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD += einsum('ij,aj,ka,ib,kb', S_oo_ab, S_ov_ab, t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        IjlD += einsum('ij,ak,ia,jb,kb', S_oo_ab, S_ov_ab, t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,kb,ia,jb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ib,kb,klac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ib,kb,klac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,ib,kc,klac,lb', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ib,kc,lkac,lb', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ka,kb,ilbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ka,kb,ilbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,ka,lb,ilbc,kc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,ka,lb,ilcb,kc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,kb,kc,ilab,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,kb,lb,ikac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,kb,kc,ilab,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,aj,kb,lb,ikac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,ia,jb,klbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,ia,jb,lkcb,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjlD += einsum('ij,ak,ia,lb,jc,lkbc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IjlD -= einsum('ij,ak,ia,lb,jc,klbc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,ak,ib,jc,lkac,lb', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjlD -= einsum('ij,ak,ib,lb,jc,lkac', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,jb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,jb,kb,ilac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,ak,jb,kc,ilab,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,ak,jb,la,ikcb,lc', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IjlD -= 1/2 * einsum('ij,ak,jb,lb,ikac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,kb,lc,ilac,jb', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_bb, optimize = einsum_type)
        IjlD -= einsum('ij,ak,kb,lb,ilac,jc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,kb,lc,ilac,jb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= einsum('ij,ak,la,lb,ikbc,jc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,lb,lb,ikac,jc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,lb,lb,ikac,jc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IjlD -= einsum('ij,ak,lb,lc,ikab,jc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)

#        IjlD  = einsum('IjDa,la->IjlD', Y_abab, Y_bb, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,ka->IjlD', np.identity(ncore), Y_aaaa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,ka->IjlD', np.identity(ncore), Y_abab, Y_bb, optimize = einsum_type)
#        IjlD += einsum('ID,ja,la->IjlD', t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        IjlD += einsum('IjDa,lkab,kb->IjlD', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjlD += einsum('IjDa,klba,kb->IjlD', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('Ijab,klab,kD->IjlD', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD += einsum('IkDa,klab,jb->IjlD', t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
#        IjlD -= einsum('IkDa,lkab,jb->IjlD', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jkab,lkab,ID->IjlD', t1_ccee_bbbb, Y_bbbb, Y_aa, optimize = einsum_type)
#        IjlD += einsum('ja,la,ID->IjlD', t1_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('kjDa,klba,Ib->IjlD', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD += einsum('kjab,klab,ID->IjlD', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD += einsum('ID,ja,la->IjlD', t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        IjlD += einsum('ja,la,ID->IjlD', t2_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('ID,la,jkab,kb->IjlD', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('ID,la,kjba,kb->IjlD', Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjlD += einsum('ID,ka,kjab,lb->IjlD', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= einsum('ID,ka,jkab,lb->IjlD', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('Ia,lb,ka,kjDb->IjlD', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjlD -= einsum('Ia,ka,kjDb,lb->IjlD', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('ja,la,IkDb,kb->IjlD', Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('ja,la,IkDb,kb->IjlD', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('ja,lb,ka,IkDb->IjlD', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        IjlD += einsum('ja,kb,la,IkDb->IjlD', Y_bb, Y_aa, t1_ce_bb, t1_ccee_aaaa, optimize = einsum_type)
#        IjlD -= einsum('ja,ka,IkDb,lb->IjlD', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += einsum('ja,kb,la,IkDb->IjlD', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('la,kD,Ijba,kb->IjlD', Y_bb, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('la,ka,kb,IjDb->IjlD', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        IjlD -= einsum('kD,ka,Ijab,lb->IjlD', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += einsum('ka,ka,IjDb,lb->IjlD', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += einsum('ka,ka,IjDb,lb->IjlD', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= einsum('ka,kb,IjDa,lb->IjlD', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= einsum('jl,ID,ka,ka->IjlD', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,ID,ka,ka->IjlD', np.identity(ncore), t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        IjlD += einsum('jl,kD,ka,Ia->IjlD', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,kmab,mb->IjlD', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,kmab,mb->IjlD', np.identity(ncore), t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,Ikab,kmab,mD->IjlD', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjlD += einsum('jl,Ia,ka,kD->IjlD', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,kmab,mb->IjlD', np.identity(ncore), t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        IjlD -= einsum('jl,IkDa,mkba,mb->IjlD', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD += einsum('jl,Ikab,mkab,mD->IjlD', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,kmDa,kmab,Ib->IjlD', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
#        IjlD += einsum('jl,kmDa,kmba,Ib->IjlD', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,ID,ka,ka->IjlD', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD -= einsum('jl,ID,ka,ka->IjlD', np.identity(ncore), t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        IjlD += einsum('jl,kD,ka,Ia->IjlD', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD += einsum('jl,Ia,ka,kD->IjlD', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,Ia,ka,kmDb,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,Ia,ka,kmDb,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,Ia,kb,ma,kmDb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,Ia,kb,ma,mkDb->IjlD', np.identity(ncore), Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,kD,ka,Imab,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,kD,ka,Imab,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,kD,ma,kb,Imab->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,kD,ma,kb,Imba->IjlD', np.identity(ncore), Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,ka,ka,ImDb,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,ka,ka,ImDb,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,ka,kb,ImDa,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,ka,ma,IkDb,mb->IjlD', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,ka,ka,ImDb,mb->IjlD', np.identity(ncore), Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IjlD -= 1/2 * einsum('jl,ka,ka,ImDb,mb->IjlD', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,ka,kb,ImDa,mb->IjlD', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IjlD += 1/2 * einsum('jl,ka,ma,IkDb,mb->IjlD', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#       
        AblC_ =- einsum('ai,bc,jiac,jb', S_vo_ab, S_vv_ab, Y_abab, Y_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ja,ic,jb', S_vo_ab, S_vv_ab, t1_ce_aa, Y_bb, Y_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ijcd,ka,kjbd', S_vo_ab, S_vv_ab, t1_ccee_bbbb, Y_aa, Y_abab, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,jiac,jkbd,kd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,jiac,jkbd,kd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,jiad,jkbd,kc', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,jidc,ka,jkbd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_aaaa, optimize = einsum_type)
        AblC_ -= 1/2 * einsum('ai,bc,jkad,ic,jkbd', S_vo_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_aaaa, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,jkac,id,jkbd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,jkad,ic,jkbd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ja,ic,jb', S_vo_ab, S_vv_ab, t2_ce_aa, Y_bb, Y_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AblC_ -= 1/2 * einsum('ai,bc,ic,jb,jkad,kd', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ic,jb,jkad,kd', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AblC_ += einsum('ai,bc,ic,jd,jkad,kb', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,ic,jd,kjad,kb', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += einsum('ai,bc,id,jb,jkac,kd', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,id,jd,kjac,kb', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ -= 1/2 * einsum('ai,bc,ja,jb,ikcd,kd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ja,jb,kidc,kd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,ja,jd,kidc,kb', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += einsum('ai,bc,ja,kb,kidc,jd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,ja,kd,kidc,jb', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ -= einsum('ai,bc,ja,kd,ikcd,jb', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_aa, optimize = einsum_type)
        AblC_ += einsum('ai,bc,jb,jd,kiac,kd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += einsum('ai,bc,jb,kc,jiad,kd', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,jd,jd,kiac,kb', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,jd,kd,jiac,kb', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ += 2 * einsum('ai,bc,jc,jd,kiad,kb', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC_ -= 2 * einsum('ai,bc,jd,jd,kiac,kb', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)

        
        AbcL =- einsum('LiAb,ic->AbcL', Y_abab, Y_bb, optimize = einsum_type)
        AbcL -= einsum('LA,ib,ic->AbcL', t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AbcL -= einsum('LiAd,ijdc,jb->AbcL', t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        AbcL -= einsum('LiAb,ijcd,jd->AbcL', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AbcL -= einsum('LiAb,jidc,jd->AbcL', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AbcL += einsum('LiAd,ijcd,jb->AbcL', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AbcL += einsum('Lidb,jidc,jA->AbcL', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AbcL -= einsum('ib,ic,LA->AbcL', t1_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        AbcL += einsum('ijAb,ijdc,Ld->AbcL', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AbcL -= einsum('ijdb,ijdc,LA->AbcL', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AbcL -= 1/2 * einsum('ijbd,ijcd,LA->AbcL', t1_ccee_bbbb, Y_bbbb, Y_aa, optimize = einsum_type)
        AbcL -= einsum('LA,ib,ic->AbcL', t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AbcL -= einsum('ib,ic,LA->AbcL', t2_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        AbcL -= einsum('LA,id,ijdb,jc->AbcL', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL -= 1/2 * einsum('LA,ic,ijbd,jd->AbcL', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AbcL -= 1/2 * einsum('LA,ic,jidb,jd->AbcL', Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AbcL += einsum('LA,id,ijbd,jc->AbcL', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AbcL += einsum('Ld,id,ijAb,jc->AbcL', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL += 1/2 * einsum('Ld,ic,jd,jiAb->AbcL', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AbcL += einsum('iA,id,Ljdb,jc->AbcL', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL += 1/2 * einsum('iA,jc,id,Ljdb->AbcL', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AbcL -= einsum('id,id,LjAb,jc->AbcL', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL -= 1/2 * einsum('ib,ic,LjAd,jd->AbcL', Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AbcL -= 1/2 * einsum('ib,ic,LjAd,jd->AbcL', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL += einsum('ib,id,LjAd,jc->AbcL', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL -= einsum('ib,jd,ic,LjAd->AbcL', Y_bb, Y_aa, t1_ce_bb, t1_ccee_aaaa, optimize = einsum_type)
        AbcL += 1/2 * einsum('ib,jc,id,LjAd->AbcL', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AbcL -= einsum('ib,jd,ic,LjAd->AbcL', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AbcL += 1/2 * einsum('ic,id,jd,LjAb->AbcL', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AbcL -= einsum('id,id,LjAb,jc->AbcL', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AbcL += einsum('id,jd,LiAb,jc->AbcL', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
       
#        S_ov_ab = delta[nocc_a:,:nocc_b].copy()
#        AjdC =- einsum('ai,bc,jiac,jb', S_ov_ab, S_vv_ab, Y_abab, Y_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ja,ic,jb', S_ov_ab, S_vv_ab, t1_ce_aa, Y_bb, Y_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ic,ja,jb', S_ov_ab, S_vv_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ijcd,ka,kjbd', S_ov_ab, S_vv_ab, t1_ccee_bbbb, Y_aa, Y_abab, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,jiac,jkbd,kd', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,jiac,jkbd,kd', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        AjdC += einsum('ai,bc,jiad,jkbd,kc', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        AjdC += einsum('ai,bc,jidc,ka,jkbd', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_aaaa, optimize = einsum_type)
#        AjdC -= 1/2 * einsum('ai,bc,jkad,ic,jkbd', S_ov_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_aaaa, optimize = einsum_type)
#        AjdC += einsum('ai,bc,jkac,id,jkbd', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,jkad,ic,jkbd', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ja,ic,jb', S_ov_ab, S_vv_ab, t2_ce_aa, Y_bb, Y_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ic,ja,jb', S_ov_ab, S_vv_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        AjdC -= 1/2 * einsum('ai,bc,ic,jb,jkad,kd', S_ov_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjdC -= 1/2 * einsum('ai,bc,ic,jb,jkad,kd', S_ov_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjdC += einsum('ai,bc,ic,jd,jkad,kb', S_ov_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ic,jd,kjad,kb', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += 1/2 * einsum('ai,bc,id,jb,jkac,kd', S_ov_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjdC += einsum('ai,bc,id,jd,kjac,kb', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC -= 1/2 * einsum('ai,bc,ja,jb,ikcd,kd', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        AjdC -= 1/2 * einsum('ai,bc,ja,jb,kidc,kd', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += einsum('ai,bc,ja,jd,kidc,kb', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += 1/2 * einsum('ai,bc,ja,kb,kidc,jd', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ja,kd,kidc,jb', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,ja,kd,ikcd,jb', S_ov_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_aa, optimize = einsum_type)
#        AjdC += 1/2 * einsum('ai,bc,jb,jd,kiac,kd', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += 1/2 * einsum('ai,bc,jb,kc,jiad,kd', S_ov_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,jd,jd,kiac,kb', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += einsum('ai,bc,jd,kd,jiac,kb', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC += einsum('ai,bc,jc,jd,kiad,kb', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjdC -= einsum('ai,bc,jd,jd,kiac,kb', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        
        
        AjdC =- einsum('iA,ijCd->AjdC', Y_aa, Y_abab, optimize = einsum_type)
        AjdC -= einsum('iC,iA,jd->AjdC', t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        AjdC -= einsum('jd,iA,iC->AjdC', t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AjdC -= einsum('jidb,kiAb,kC->AjdC', t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        AjdC -= einsum('ijCd,ikAb,kb->AjdC', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        AjdC -= einsum('ijCd,ikAb,kb->AjdC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AjdC += einsum('ijCb,ikAb,kd->AjdC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AjdC += einsum('ijbd,ikAb,kC->AjdC', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        AjdC -= 1/2 * einsum('ikCb,ikAb,jd->AjdC', t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
        AjdC += einsum('ikCd,ikAb,jb->AjdC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AjdC -= einsum('ikCb,ikAb,jd->AjdC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AjdC -= einsum('iC,iA,jd->AjdC', t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        AjdC -= einsum('jd,iA,iC->AjdC', t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AjdC -= 1/2 * einsum('jd,iA,ikCb,kb->AjdC', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjdC -= 1/2 * einsum('jd,iA,ikCb,kb->AjdC', Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjdC += einsum('jd,ib,ikCb,kA->AjdC', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjdC -= einsum('jd,ib,kiCb,kA->AjdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC += 1/2 * einsum('jb,iA,kb,ikCd->AjdC', Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AjdC += einsum('jb,ib,kiCd,kA->AjdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC -= 1/2 * einsum('iA,iC,jkdb,kb->AjdC', Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AjdC -= 1/2 * einsum('iA,iC,kjbd,kb->AjdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC += 1/2 * einsum('iA,ib,kb,kjCd->AjdC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjdC += 1/2 * einsum('iA,kC,ijbd,kb->AjdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC += 1/2 * einsum('iA,kd,ijCb,kb->AjdC', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjdC += einsum('iC,ib,kjbd,kA->AjdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC -= einsum('iC,kb,iA,kjbd->AjdC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjdC -= einsum('iC,kb,iA,jkdb->AjdC', Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
        AjdC -= einsum('ib,ib,kA,kjCd->AjdC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjdC += einsum('ib,kb,iA,kjCd->AjdC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjdC += einsum('id,ib,kjCb,kA->AjdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjdC -= einsum('ib,ib,kA,kjCd->AjdC', Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        
#        S_vo_ab = delta[:nocc_a,nocc_b:].copy()
#        AbcL =- einsum('ia,bc,ijba,jc', S_vo_ab, S_vv_ab, Y_abab, Y_bb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ib,ja,jc', S_vo_ab, S_vv_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ijbd,ka,jkdc', S_vo_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_abab, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,ijba,jkcd,kd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,ijba,kjdc,kd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,ijbd,ka,jkcd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_bbbb, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,ijda,kb,kjdc', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ja,ib,jc', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,jkba,id,jkdc', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,jkda,ib,jkdc', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AbcL -= 1/2 * einsum('ia,bc,jkad,ib,jkcd', S_vo_ab, S_vv_ab, t1_ccee_bbbb, Y_aa, Y_bbbb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ib,ja,jc', S_vo_ab, S_vv_ab, t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ja,ib,jc', S_vo_ab, S_vv_ab, t2_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,ib,jd,jkda,kc', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL -= 1/2 * einsum('ia,bc,ib,jc,jkad,kd', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ib,jc,kjda,kd', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AbcL += einsum('ia,bc,ib,jd,jkad,kc', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,id,jd,jkba,kc', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL += einsum('ia,bc,id,jc,kjba,kd', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,jb,jd,ikda,kc', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL += einsum('ia,bc,jb,kc,ikda,jd', S_vo_ab, S_vv_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,jd,jd,ikba,kc', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL -= 1/2 * einsum('ia,bc,ja,jc,ikbd,kd', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ja,jc,ikbd,kd', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,ja,jd,ikbd,kc', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL -= einsum('ia,bc,ja,kd,ikbd,jc', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_bb, optimize = einsum_type)
#        AbcL += einsum('ia,bc,ja,kc,ikbd,jd', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,ja,kd,ikbd,jc', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL += einsum('ia,bc,jc,jd,ikba,kd', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL -= 2 * einsum('ia,bc,jd,jd,ikba,kc', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AbcL += 2 * einsum('ia,bc,jd,kd,ijba,kc', S_vo_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)

        
        AblC =- einsum('iC,ilAb->AblC', Y_aa, Y_abab, optimize = einsum_type)
        AblC -= einsum('iA,iC,lb->AblC', t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        AblC -= einsum('lb,iA,iC->AblC', t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AblC -= einsum('libd,jiCd,jA->AblC', t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        AblC -= einsum('ilAb,ijCd,jd->AblC', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        AblC -= einsum('ilAb,ijCd,jd->AblC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC += einsum('ilAd,ijCd,jb->AblC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC += einsum('ildb,ijCd,jA->AblC', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        AblC -= 1/2 * einsum('ijAd,ijCd,lb->AblC', t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
        AblC += einsum('ijAb,ijCd,ld->AblC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC -= einsum('ijAd,ijCd,lb->AblC', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        AblC -= einsum('iA,iC,lb->AblC', t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        AblC -= einsum('lb,iA,iC->AblC', t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        AblC -= 1/2 * einsum('lb,iC,ijAd,jd->AblC', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AblC -= 1/2 * einsum('lb,iC,ijAd,jd->AblC', Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AblC += einsum('lb,id,ijAd,jC->AblC', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AblC -= einsum('lb,id,jiAd,jC->AblC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC += 1/2 * einsum('ld,iC,jd,ijAb->AblC', Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AblC += einsum('ld,id,jiAb,jC->AblC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC -= 1/2 * einsum('iA,iC,ljbd,jd->AblC', Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AblC -= 1/2 * einsum('iA,iC,jldb,jd->AblC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC += einsum('iA,id,jldb,jC->AblC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC += 1/2 * einsum('iA,jC,id,jldb->AblC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AblC -= einsum('iA,jd,iC,jldb->AblC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AblC -= einsum('iA,jd,iC,ljbd->AblC', Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
        AblC += 1/2 * einsum('iC,id,jd,jlAb->AblC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AblC += 1/2 * einsum('iC,jb,ilAd,jd->AblC', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AblC -= einsum('id,id,jC,jlAb->AblC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AblC += einsum('id,jd,iC,jlAb->AblC', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AblC += einsum('ib,id,jlAd,jC->AblC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AblC -= einsum('id,id,jC,jlAb->AblC', Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
...
#        AjlK += einsum('ij,ak,ikab,jb', S_oo_ab, S_vo_ab, Y_abab, Y_bb, optimize = einsum_type)
...
#        AjlK -= 2 * einsum('ij,aj,ikab,klbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,aj,ikab,lkcb,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,aj,ikbc,la,lkbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AjlK += einsum('ij,aj,ka,ib,kb', S_oo_ab, S_vo_ab, t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
#        AjlK -= 1/2 * einsum('ij,aj,klab,ic,klbc', S_oo_ab, S_vo_ab, t1_ccee_aaaa, Y_aa, Y_aaaa, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,aj,klab,ic,klcb', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AjlK += einsum('ij,ak,ia,jb,kb', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,ikab,jlbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,ikab,ljcb,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,ikbc,ljbc,la', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
#        AjlK += einsum('ij,ak,ilab,ljbc,kc', S_oo_ab, S_vo_ab, t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,ilab,jlbc,kc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
#        AjlK += 1/2 * einsum('ij,ak,klbc,ia,jlbc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_aa, Y_bbbb, optimize = einsum_type)
#        AjlK += einsum('ij,ak,kb,ia,jb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,lkab,ic,ljcb', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,lkbc,ia,ljbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
...
#        AjlK += einsum('ij,ak,kb,ia,jb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
#        AjlK += 1/2 * einsum('ij,aj,ib,kb,klac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK += einsum('ij,aj,ib,kb,klac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= 1/2 * einsum('ij,aj,ib,kc,klac,lb', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK += einsum('ij,aj,ib,kc,lkac,lb', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjlK += 1/2 * einsum('ij,aj,ka,kb,ilbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK += einsum('ij,aj,ka,kb,ilbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= 1/2 * einsum('ij,aj,ka,lb,ilbc,kc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK += einsum('ij,aj,ka,lb,ilcb,kc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjlK -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK -= einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
...
#        AjlK -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK -= einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += einsum('ij,aj,kb,kc,ilab,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += einsum('ij,aj,kb,lb,ikac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += 1/2 * einsum('ij,ak,ia,jb,klbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        AjlK += einsum('ij,ak,ia,jb,lkcb,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,ia,lb,jc,lkbc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        AjlK -= einsum('ij,ak,ia,lb,jc,klbc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
#        AjlK -= einsum('ij,ak,ib,jc,lkac,lb', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,ib,lb,jc,lkac', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
#        AjlK += 1/2 * einsum('ij,ak,jb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        AjlK += einsum('ij,ak,jb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= einsum('ij,ak,jb,kc,ilab,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= einsum('ij,ak,jb,la,ikcb,lc', S_oo_ab, S_vo_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        AjlK -= einsum('ij,ak,jb,lb,ikac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += einsum('ij,ak,kb,lc,ilac,jb', S_oo_ab, S_vo_ab, Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,kb,lb,ilac,jc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,kb,lc,ilac,jb', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,la,lb,ikbc,jc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,lb,lb,ikac,jc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK += 2 * einsum('ij,ak,lb,lb,ikac,jc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        AjlK -= 2 * einsum('ij,ak,lb,lc,ikab,jc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
                
        AjlK  = einsum('KlAb,jb->AjlK', Y_abab, Y_bb, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,ib->AjlK', np.identity(ncore), Y_aaaa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,ib->AjlK', np.identity(ncore), Y_abab, Y_bb, optimize = einsum_type)
        AjlK += einsum('KA,jb,lb->AjlK', t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AjlK += einsum('KlAb,jibc,ic->AjlK', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AjlK += einsum('KlAb,ijcb,ic->AjlK', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK -= einsum('Klbc,ijbc,iA->AjlK', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK += einsum('KiAb,ijbc,lc->AjlK', t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        AjlK -= einsum('KiAb,jibc,lc->AjlK', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('libc,jibc,KA->AjlK', t1_ccee_bbbb, Y_bbbb, Y_aa, optimize = einsum_type)
        AjlK += einsum('lb,jb,KA->AjlK', t1_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        AjlK -= einsum('ilAb,ijcb,Kc->AjlK', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK += einsum('ilbc,ijbc,KA->AjlK', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK += einsum('KA,jb,lb->AjlK', t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AjlK += einsum('lb,jb,KA->AjlK', t2_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('KA,jb,libc,ic->AjlK', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('KA,jb,ilcb,ic->AjlK', Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjlK += einsum('KA,ib,ilbc,jc->AjlK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= einsum('KA,ib,libc,jc->AjlK', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('Kb,jc,ib,ilAc->AjlK', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjlK -= einsum('Kb,ib,ilAc,jc->AjlK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('jb,lb,KiAc,ic->AjlK', Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jb,lb,KiAc,ic->AjlK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jb,lc,KiAb,ic->AjlK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jb,iA,Klcb,ic->AjlK', Y_bb, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jb,ib,ic,KlAc->AjlK', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AjlK += einsum('lb,ic,jb,KiAc->AjlK', Y_bb, Y_aa, t1_ce_bb, t1_ccee_aaaa, optimize = einsum_type)
        AjlK -= einsum('lb,ib,KiAc,jc->AjlK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += einsum('lb,ic,jb,KiAc->AjlK', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        AjlK -= einsum('iA,ib,Klbc,jc->AjlK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += einsum('ib,ib,KlAc,jc->AjlK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += einsum('ib,ib,KlAc,jc->AjlK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= einsum('ib,ic,KlAb,jc->AjlK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= einsum('jl,KA,ib,ib->AjlK', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KA,ib,ib->AjlK', np.identity(ncore), t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AjlK += einsum('jl,iA,ib,Kb->AjlK', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,imbc,mc->AjlK', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,imbc,mc->AjlK', np.identity(ncore), t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,Kibc,imbc,mA->AjlK', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
        AjlK += einsum('jl,Kb,ib,iA->AjlK', np.identity(ncore), t1_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,imbc,mc->AjlK', np.identity(ncore), t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AjlK -= einsum('jl,KiAb,micb,mc->AjlK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK += einsum('jl,Kibc,mibc,mA->AjlK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,imAb,imbc,Kc->AjlK', np.identity(ncore), t1_ccee_aaaa, Y_aaaa, Y_aa, optimize = einsum_type)
        AjlK += einsum('jl,imAb,imcb,Kc->AjlK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KA,ib,ib->AjlK', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK -= einsum('jl,KA,ib,ib->AjlK', np.identity(ncore), t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AjlK += einsum('jl,iA,ib,Kb->AjlK', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK += einsum('jl,Kb,ib,iA->AjlK', np.identity(ncore), t2_ce_aa, Y_aa, Y_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,Kb,ib,imAc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,Kb,ib,imAc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,Kb,ic,mb,imAc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,Kb,ic,mb,miAc->AjlK', np.identity(ncore), Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,iA,ib,Kmbc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,iA,ib,Kmbc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,iA,mb,ic,Kmbc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,iA,mb,ic,Kmcb->AjlK', np.identity(ncore), Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,ib,ib,KmAc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,ib,ib,KmAc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,ib,ic,KmAb,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,ib,mb,KiAc,mc->AjlK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,ib,ib,KmAc,mc->AjlK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        AjlK -= 1/2 * einsum('jl,ib,ib,KmAc,mc->AjlK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,ib,ic,KmAb,mc->AjlK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        AjlK += 1/2 * einsum('jl,ib,mb,KiAc,mc->AjlK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
...
#        IbdC -= einsum('ia,bc,ijbd,ka,jkdc', S_ov_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_abab, optimize = einsum_type)
...
#        IbdC += einsum('ia,bc,jkba,id,jkdc', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
#        IbdC -= einsum('ia,bc,jkda,ib,jkdc', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
...
#        IbdC += einsum('ia,bc,id,jd,jkba,kc', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
...
#        IbdC -= 1/2 * einsum('ia,bc,ja,jc,ikbd,kd', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
...
#        IbdC += 1/2 * einsum('ia,bc,ja,kc,ikbd,jd', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
...
#        IbdC += einsum('ia,bc,jd,kd,ijba,kc', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        ...
        IbdC =- einsum('IjCd,jb->IbdC', Y_abab, Y_bb, optimize = einsum_type)
        IbdC -= einsum('IC,jb,jd->IbdC', t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IbdC -= einsum('IjCa,jkab,kd->IbdC', t1_ccee_aaaa, Y_abab, Y_bb, optimize = einsum_type)
        IbdC -= einsum('IjCd,jkba,ka->IbdC', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IbdC -= einsum('IjCd,kjab,ka->IbdC', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IbdC += einsum('IjCa,jkba,kd->IbdC', t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IbdC += einsum('Ijad,kjab,kC->IbdC', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IbdC -= einsum('jd,jb,IC->IbdC', t1_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        IbdC += einsum('jkCd,jkab,Ia->IbdC', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IbdC -= einsum('jkad,jkab,IC->IbdC', t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        IbdC -= 1/2 * einsum('jkda,jkba,IC->IbdC', t1_ccee_bbbb, Y_bbbb, Y_aa, optimize = einsum_type)
        IbdC -= einsum('IC,jb,jd->IbdC', t2_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IbdC -= einsum('jd,jb,IC->IbdC', t2_ce_bb, Y_bb, Y_aa, optimize = einsum_type)
        IbdC -= einsum('IC,ja,jkad,kb->IbdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC -= 1/2 * einsum('IC,jb,jkda,ka->IbdC', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IbdC -= 1/2 * einsum('IC,jb,kjad,ka->IbdC', Y_aa, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IbdC += einsum('IC,ja,jkda,kb->IbdC', Y_aa, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IbdC += einsum('Ia,ja,jkCd,kb->IbdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC += 1/2 * einsum('Ia,jb,ka,kjCd->IbdC', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IbdC += einsum('jC,ja,Ikad,kb->IbdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC += 1/2 * einsum('jC,kb,ja,Ikad->IbdC', Y_aa, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IbdC -= einsum('ja,ja,IkCd,kb->IbdC', Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC -= 1/2 * einsum('jb,jd,IkCa,ka->IbdC', Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IbdC -= 1/2 * einsum('jb,jd,IkCa,ka->IbdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC += 1/2 * einsum('jb,ja,ka,IkCd->IbdC', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IbdC += 1/2 * einsum('jb,kd,IjCa,ka->IbdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC += einsum('jd,ja,IkCa,kb->IbdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC -= einsum('jd,ka,jb,IkCa->IbdC', Y_bb, Y_aa, t1_ce_bb, t1_ccee_aaaa, optimize = einsum_type)
        IbdC -= einsum('jd,ka,jb,IkCa->IbdC', Y_bb, Y_bb, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IbdC -= einsum('ja,ja,IkCd,kb->IbdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IbdC += einsum('ja,ka,IjCd,kb->IbdC', Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        
#        S_vo_ab = delta[:nocc_a,nocc_b:].copy()
#        IblK =- einsum('ij,ia,jkab,kb', S_oo_ab, S_vo_ab, Y_bbbb, Y_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ia,kjba,kb', S_oo_ab, S_vo_ab, Y_abab, Y_aa, optimize = einsum_type)
#        IblK += einsum('ij,ka,ib,kjba', S_oo_ab, S_vo_ab, Y_aa, Y_abab, optimize = einsum_type)
#        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ia,jkab,klbc,lc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ia,jkab,lkcb,lc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,jkbc,la,klbc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
#        IblK += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ia,kjbc,la,klbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ia,klba,jc,klbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,klab,jc,klbc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
#        IblK += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IblK += einsum('ij,ka,jlab,ilcb,kc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,kjbc,ilbc,la', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_vo_ab, t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_vo_ab, t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,klba,ilbc,jc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,ljba,ilbc,kc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
#        IblK += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_vo_ab, t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,jb,kc,klca,lb', S_oo_ab, S_vo_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ia,jb,kb,klac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,jb,kb,lkca,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,jb,kc,klac,lb', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK += einsum('ij,ia,kb,kc,ljba,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK += einsum('ij,ia,kb,lb,kjca,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ia,ka,kb,jlbc,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK += einsum('ij,ia,ka,kb,ljcb,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK += einsum('ij,ia,ka,lb,ljbc,kc', S_oo_ab, S_vo_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,ka,lb,jlbc,kc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ia,kb,kc,jlab,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ia,kb,lb,jkac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
#        IblK += einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ka,ib,jc,klba,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IblK += 1/2 * einsum('ij,ka,ib,kb,jlac,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
#        IblK += einsum('ij,ka,ib,kb,ljca,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ka,ib,kc,ljba,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ka,ib,lb,kjca,lc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
#        IblK -= einsum('ij,ka,ib,la,kjbc,lc', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
#        IblK -= einsum('ij,ka,ja,lb,ic,klbc', S_oo_ab, S_vo_ab, Y_bb, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,ja,lb,ic,klcb', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,jb,lb,ic,klca', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,kb,lb,ic,ljca', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,kb,lc,ib,ljca', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK += einsum('ij,ka,kb,lc,ib,jlac', S_oo_ab, S_vo_ab, Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,lb,lc,ib,kjca', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK -= 2 * einsum('ij,ka,la,lb,ic,kjcb', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
#        IblK += 2 * einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        
        ncore = nocc_a
        IblK  = einsum('Ia,Klab->IblK', Y_aa, Y_abab, optimize = einsum_type)
        IblK -= einsum('IK,ljba,ja->IblK', np.identity(ncore), Y_bbbb, Y_bb, optimize = einsum_type)
        IblK -= einsum('IK,jlab,ja->IblK', np.identity(ncore), Y_abab, Y_aa, optimize = einsum_type)
        IblK += einsum('Klab,Ijac,jc->IblK', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK += einsum('Klab,Ijac,jc->IblK', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK -= einsum('Klac,Ijac,jb->IblK', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('Kjac,Ijac,lb->IblK', t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
        IblK += einsum('Ka,Ia,lb->IblK', t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IblK -= einsum('Kjab,Ijac,lc->IblK', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('Kjac,Ijac,lb->IblK', t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('lb,Ia,Ka->IblK', t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK += einsum('ljba,Ijca,Kc->IblK', t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IblK -= einsum('jlab,Ijac,Kc->IblK', t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK += einsum('Ka,Ia,lb->IblK', t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IblK += einsum('lb,Ia,Ka->IblK', t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('Ia,Ka,ljbc,jc->IblK', Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('Ia,Ka,jlcb,jc->IblK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('Ia,Kc,jlab,jc->IblK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('Ia,lb,Kjac,jc->IblK', Y_aa, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('Ia,lb,Kjac,jc->IblK', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('Ia,lc,Kjab,jc->IblK', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('Ia,ja,jc,Klcb->IblK', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= 1/2 * einsum('Ia,jb,Klac,jc->IblK', Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= einsum('Ka,ja,jlcb,Ic->IblK', Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += einsum('Ka,jc,Ia,jlcb->IblK', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK += einsum('Ka,jc,Ia,ljbc->IblK', Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
        IblK -= einsum('lb,ja,Kjac,Ic->IblK', Y_bb, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IblK += einsum('lb,ja,Kjca,Ic->IblK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= einsum('la,ja,Kjcb,Ic->IblK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += einsum('ja,ja,Ic,Klcb->IblK', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('ja,jc,Ia,Klcb->IblK', Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('jb,ja,Klca,Ic->IblK', Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += einsum('ja,ja,Ic,Klcb->IblK', Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('IK,lb,ja,ja->IblK', np.identity(ncore), t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK -= einsum('IK,lb,ja,ja->IblK', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,jb,ja,la->IblK', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK -= einsum('IK,ljba,jmac,mc->IblK', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
        IblK -= einsum('IK,ljba,mjca,mc->IblK', np.identity(ncore), t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,ljac,jmac,mb->IblK', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,la,ja,jb->IblK', np.identity(ncore), t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK -= einsum('IK,jlab,jmac,mc->IblK', np.identity(ncore), t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK -= einsum('IK,jlab,jmac,mc->IblK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,jlac,jmac,mb->IblK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,jmab,jmac,lc->IblK', np.identity(ncore), t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,jmba,jmac,lc->IblK', np.identity(ncore), t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
        IblK -= einsum('IK,lb,ja,ja->IblK', np.identity(ncore), t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK -= einsum('IK,lb,ja,ja->IblK', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,jb,ja,la->IblK', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('IK,la,ja,jb->IblK', np.identity(ncore), t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,la,jc,ma,jmcb->IblK', np.identity(ncore), Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,la,ja,jmbc,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,la,ja,mjcb,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,la,jc,ma,jmbc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,ja,ja,lmbc,mc->IblK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,ja,ja,mlcb,mc->IblK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,ja,jc,ma,mlcb->IblK', np.identity(ncore), Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,ja,ma,jlcb,mc->IblK', np.identity(ncore), Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,jb,ja,lmac,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,jb,ja,mlca,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,jb,ma,jc,mlac->IblK', np.identity(ncore), Y_bb, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,jb,ma,jc,lmac->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ce_bb, t1_ccee_bbbb, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,ja,ja,lmbc,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('IK,ja,ja,mlcb,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,ja,jc,lmba,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('IK,ja,ma,ljbc,mc->IblK', np.identity(ncore), Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
       ...
       # del S_vo_ab 
        ...
        if (method == "adc(2)-x") or (method == "adc(3)"):
            ...
            IjLd += einsum('Ia,Lkab,kjbd->IjLd', t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            IjLd += einsum('Ia,Lkab,jkdb->IjLd', t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            IjLd += 1/2 * einsum('jd,Ikab,Lkab->IjLd', t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjLd += einsum('jd,Ikab,Lkab->IjLd', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd -= einsum('kd,Lkab,Ijab->IjLd', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd -= einsum('ja,Lkba,Ikbd->IjLd', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd -= 1/4 * einsum('IL,jd,kmab,kmab->IjLd', np.identity(ncore), t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjLd -= einsum('IL,jd,kmab,kmab->IjLd', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd -= 1/4 * einsum('IL,jd,kmab,kmab->IjLd', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjLd += 1/2 * einsum('IL,kd,kmab,jmab->IjLd', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjLd += einsum('IL,kd,mkab,mjab->IjLd', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd += einsum('IL,ja,kmba,kmbd->IjLd', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjLd += 1/2 * einsum('IL,ja,kmab,kmdb->IjLd', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
        
            
            ncore = nocc_b
            IjlD += 1/2 * einsum('ID,jkab,lkab->IjlD', t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjlD += einsum('ID,kjab,klab->IjlD', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IjlD -= einsum('kD,klab,Ijab->IjlD', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IjlD -= einsum('Ia,klab,kjDb->IjlD', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IjlD += einsum('ja,lkab,IkDb->IjlD', t1_ce_bb, Y_bbbb, Y_abab, optimize = einsum_type)
            IjlD += einsum('ja,klba,IkDb->IjlD', t1_ce_bb, Y_abab, Y_aaaa, optimize = einsum_type)
            IjlD -= 1/4 * einsum('jl,ID,kmab,kmab->IjlD', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjlD -= einsum('jl,ID,kmab,kmab->IjlD', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IjlD -= 1/4 * einsum('jl,ID,kmab,kmab->IjlD', np.identity(ncore), t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjlD += 1/2 * einsum('jl,kD,kmab,Imab->IjlD', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjlD += einsum('jl,kD,kmab,Imab->IjlD', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IjlD += 1/2 * einsum('jl,Ia,kmab,kmDb->IjlD', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjlD += einsum('jl,Ia,kmab,kmDb->IjlD', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            
            
            AbcL -= einsum('LA,ijdb,ijdc->AbcL', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AbcL -= 1/2 * einsum('LA,ijbd,ijcd->AbcL', t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            AbcL += einsum('iA,ijdc,Ljdb->AbcL', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AbcL += einsum('Ld,ijdc,ijAb->AbcL', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AbcL -= einsum('ib,ijcd,LjAd->AbcL', t1_ce_bb, Y_bbbb, Y_abab, optimize = einsum_type)
            AbcL -= einsum('ib,jidc,LjAd->AbcL', t1_ce_bb, Y_abab, Y_aaaa, optimize = einsum_type)
            
            
            AjdC -= einsum('iC,ikAb,kjbd->AjdC', t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            AjdC -= einsum('iC,ikAb,jkdb->AjdC', t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            AjdC -= 1/2 * einsum('jd,ikAb,ikCb->AjdC', t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AjdC -= einsum('jd,ikAb,ikCb->AjdC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AjdC += einsum('id,kiAb,kjCb->AjdC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AjdC += einsum('jb,ikAb,ikCd->AjdC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            
            
            AblC -= einsum('iA,ijCd,jldb->AblC', t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            AblC -= einsum('iA,ijCd,ljbd->AblC', t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            AblC -= 1/2 * einsum('lb,ijAd,ijCd->AblC', t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AblC -= einsum('lb,ijAd,ijCd->AblC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AblC += einsum('ib,jiCd,jlAd->AblC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AblC += einsum('ld,ijCd,ijAb->AblC', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            
            AjlK  += 1/2 * einsum('KA,jibc,libc->AjlK', t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            AjlK += einsum('KA,ijbc,ilbc->AjlK', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AjlK -= einsum('iA,ijbc,Klbc->AjlK', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AjlK -= einsum('Kb,ijbc,ilAc->AjlK', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AjlK += einsum('lb,jibc,KiAc->AjlK', t1_ce_bb, Y_bbbb, Y_abab, optimize = einsum_type)
            AjlK += einsum('lb,ijcb,KiAc->AjlK', t1_ce_bb, Y_abab, Y_aaaa, optimize = einsum_type)
            AjlK -= 1/4 * einsum('jl,KA,imbc,imbc->AjlK', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AjlK -= einsum('jl,KA,imbc,imbc->AjlK', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AjlK -= 1/4 * einsum('jl,KA,imbc,imbc->AjlK', np.identity(ncore), t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            AjlK += 1/2 * einsum('jl,iA,imbc,Kmbc->AjlK', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AjlK += einsum('jl,iA,imbc,Kmbc->AjlK', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AjlK += 1/2 * einsum('jl,Kb,imbc,imAc->AjlK', np.identity(ncore), t1_ce_aa, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AjlK += einsum('jl,Kb,imbc,imAc->AjlK', np.identity(ncore), t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            
            IbdC -= einsum('IC,jkab,jkad->IbdC', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IbdC -= 1/2 * einsum('IC,jkba,jkda->IbdC', t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IbdC += einsum('jC,jkab,Ikad->IbdC', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IbdC += einsum('Ia,jkab,jkCd->IbdC', t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IbdC -= einsum('jd,jkba,IkCa->IbdC', t1_ce_bb, Y_bbbb, Y_abab, optimize = einsum_type)
            IbdC -= einsum('jd,kjab,IkCa->IbdC', t1_ce_bb, Y_abab, Y_aaaa, optimize = einsum_type)
            
            ncore = nocc_a
            IblK += einsum('Ka,Ijac,jlcb->IblK', t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            IblK += einsum('Ka,Ijac,ljbc->IblK', t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            IblK += 1/2 * einsum('lb,Ijac,Kjac->IblK', t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IblK += einsum('lb,Ijac,Kjac->IblK', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= einsum('jb,Ijac,Klac->IblK', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= einsum('la,Ijca,Kjcb->IblK', t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= 1/4 * einsum('IK,lb,jmac,jmac->IblK', np.identity(ncore), t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IblK -= einsum('IK,lb,jmac,jmac->IblK', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= 1/4 * einsum('IK,lb,jmac,jmac->IblK', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IblK += 1/2 * einsum('IK,jb,jmac,lmac->IblK', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IblK += einsum('IK,jb,mjac,mlac->IblK', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK += einsum('IK,la,jmca,jmcb->IblK', np.identity(ncore), t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK += 1/2 * einsum('IK,la,jmac,jmbc->IblK', np.identity(ncore), t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
...
#        IjdL = IjLd.transpose(0,1,3,2)
#        IjLd_ = einsum("pr,qs,pqrs", S_ov_ab,S_oc_ab.T, IjdL,optimize = einsum_type)
#        IjlD = einsum("pr,qs,pqrs", S_oc_ab,S_vo_ab.T, IjlD,optimize = einsum_type)
        AbcL = einsum("pr,qs,pqrs", S_vir_ab,S_ov_ab.T, AbcL,optimize = einsum_type)
        AjdC = einsum("pr,qs,pqrs", S_vir_ab,S_vo_ab.T, AjdC,optimize = einsum_type)
        AblC = einsum("pr,qs,pqrs", S_vo_ab,S_vir_ab.T, AblC,optimize = einsum_type)
        print(AblC)
        print(AblC_)
        exit()
        AjlK = einsum("pr,qs,pqrs", S_vo_ab,S_oc_ab.T, AjlK,optimize = einsum_type)
        IbdC = einsum("pr,qs,pqrs", S_ov_ab,S_vir_ab.T, IbdC,optimize = einsum_type)
        IblK = einsum("pr,qs,pqrs", S_oc_ab,S_ov_ab.T, IblK,optimize = einsum_type)
        ...
        #spin_c = 0.25*((na - nb)**2) + 0.5*(na + nb) + IjKl + AbCd + 2*IjCd + IaKd + 2*IaDk + AiDk + (ClAb + IjLd + IjDl + AbLc + AbCl + LdIj + LcAb + DlIj)
        spin_c = 0.25*((na - nb)**2) + 0.5*(na + nb) + IjKl + AbCd + 2*IjCd + IaKd + 2*IaDk + AiDk + IjdL + IjlD + AbcL + AjdC + AblC + AjlK + IbdC + IblK 

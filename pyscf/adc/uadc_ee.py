...
# OPDM ADC(2)-X
        ...
        IjlD += einsum('ij,ak,ikab,jb', S_oo_ab, S_vo_ab, Y_abab, Y_bb, optimize = einsum_type)
        ...
        IjlD -= 1/2 * einsum('ij,aj,klab,ic,klbc', S_oo_ab, S_vo_ab, t1_ccee_aaaa, Y_aa, Y_aaaa, optimize = einsum_type)
        IjlD += einsum('ij,aj,klab,ic,klcb', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        IjlD += einsum('ij,ak,ia,jb,kb', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,ikab,jlbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjlD += einsum('ij,ak,ikab,ljcb,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        ...
        IjlD -= einsum('ij,ak,ilab,jlbc,kc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        IjlD += 1/2 * einsum('ij,ak,klbc,ia,jlbc', S_oo_ab, S_vo_ab, t1_ccee_bbbb, Y_aa, Y_bbbb, optimize = einsum_type)
        ...
        IjlD += einsum('ij,ak,lkbc,ia,ljbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        ...
        IjlD += einsum('ij,ak,kb,ia,jb', S_oo_ab, S_vo_ab, t2_ce_bb, Y_aa, Y_bb, optimize = einsum_type)
        ...
        IjlD -= 1/2 * einsum('ij,aj,ib,kc,klac,lb', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        ...
        IjlD -= 1/2 * einsum('ij,aj,kb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        ...
        IjlD += einsum('ij,ak,ia,lb,jc,lkbc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        ...
        IjlD += 1/2 * einsum('ij,ak,jb,kb,ilac,lc', S_oo_ab, S_vo_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        ...
        AbcL -= einsum('ia,bc,ijbd,ka,jkdc', S_ov_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_abab, optimize = einsum_type)
        ...
        AbcL += einsum('ia,bc,jkba,id,jkdc', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        AbcL -= einsum('ia,bc,jkda,ib,jkdc', S_ov_ab, S_vv_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        ...
        AbcL += einsum('ia,bc,id,jd,jkba,kc', S_ov_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        ...
        AbcL -= 1/2 * einsum('ia,bc,ja,jc,ikbd,kd', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        ...
        AbcL += 1/2 * einsum('ia,bc,ja,kc,ikbd,jd', S_ov_ab, S_vv_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        ...
        AblC -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        ...
        AblC -= 1/2 * einsum('ai,bc,jkad,ic,jkbd', S_vo_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_aaaa, optimize = einsum_type)
        AblC += einsum('ai,bc,jkac,id,jkbd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        ...
        AblC -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        ...
        AblC += 1/2 * einsum('ai,bc,id,jb,jkac,kd', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        ...
        AblC -= 1/2 * einsum('ai,bc,ja,jb,kidc,kd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        ...
        AjdC -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        ...
        AjdC -= 1/2 * einsum('ai,bc,jkad,ic,jkbd', S_vo_ab, S_vv_ab, t1_ccee_aaaa, Y_bb, Y_aaaa, optimize = einsum_type)
        AjdC += einsum('ai,bc,jkac,id,jkbd', S_vo_ab, S_vv_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        ...
        AjdC -= einsum('ai,bc,ic,ja,jb', S_vo_ab, S_vv_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        ...
        AjdC += 1/2 * einsum('ai,bc,id,jb,jkac,kd', S_vo_ab, S_vv_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        ...
        AjdC -= 1/2 * einsum('ai,bc,ja,jb,kidc,kd', S_vo_ab, S_vv_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        ...
        AjlK += einsum('ij,aj,klab,ic,klcb', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        AjlK += einsum('ij,ak,ia,jb,kb', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bb, Y_bb, optimize = einsum_type)
        AjlK += einsum('ij,ak,ikab,jlbc,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        AjlK += einsum('ij,ak,ikab,ljcb,lc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_abab, Y_aa, optimize = einsum_type)
        ...
        AjlK -= einsum('ij,ak,ilab,jlbc,kc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_bbbb, Y_bb, optimize = einsum_type)
        ...
        AjlK += einsum('ij,ak,lkbc,ia,ljbc', S_oo_ab, S_vo_ab, t1_ccee_abab, Y_aa, Y_abab, optimize = einsum_type)
        ...
        AjlK += einsum('ij,ak,ia,lb,jc,lkbc', S_oo_ab, S_vo_ab, Y_aa, Y_aa, t1_ce_bb, t1_ccee_abab, optimize = einsum_type)
        ...
        IblK =- einsum('ij,ia,jkab,kb', S_oo_ab, S_ov_ab, Y_bbbb, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ia,kjba,kb', S_oo_ab, S_ov_ab, Y_abab, Y_aa, optimize = einsum_type)
        IblK += einsum('ij,ka,ib,kjba', S_oo_ab, S_ov_ab, Y_aa, Y_abab, optimize = einsum_type)
        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ia,jkab,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bbbb, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ia,jkab,lkcb,lc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,jkbc,la,klbc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
        IblK += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK -= einsum('ij,ia,kjba,klbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ia,kjbc,la,klbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        IblK += einsum('ij,ia,klba,jc,klbc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_bb, Y_abab, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,klab,jc,klbc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_bb, Y_bbbb, optimize = einsum_type)
        IblK += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK += einsum('ij,ka,jlab,ilcb,kc', S_oo_ab, S_ov_ab, t1_ccee_bbbb, Y_abab, Y_aa, optimize = einsum_type)
        IblK += einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK += einsum('ij,ka,kjba,ilbc,lc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ka,kjbc,ilbc,la', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_ov_ab, t1_ccee_aaaa, Y_aaaa, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ka,klba,ilbc,jc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ka,klbc,ilbc,ja', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_abab, Y_bb, optimize = einsum_type)
        IblK -= einsum('ij,ka,ljba,ilbc,kc', S_oo_ab, S_ov_ab, t1_ccee_abab, Y_aaaa, Y_aa, optimize = einsum_type)
        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK -= einsum('ij,ia,ja,kb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ia,jb,ka,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ia,ka,jb,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_bb, Y_bb, optimize = einsum_type)
        IblK += einsum('ij,ka,ja,ib,kb', S_oo_ab, S_ov_ab, t2_ce_bb, Y_aa, Y_aa, optimize = einsum_type)
        IblK += einsum('ij,ka,kb,ib,ja', S_oo_ab, S_ov_ab, t2_ce_aa, Y_aa, Y_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,jb,kc,klca,lb', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,jb,kb,klac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,jb,kb,lkca,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,jb,kc,klac,lb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,kb,kc,ljba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,kb,lb,kjca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,ka,kb,jlbc,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,ka,kb,ljcb,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,ka,lb,ljbc,kc', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,ka,lb,jlbc,kc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,kb,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ia,kb,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,kb,kc,jlab,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ia,kb,lb,jkac,lc', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_aaaa, t1_ce_aa, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ka,ib,ja,klbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ka,ib,jc,klba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ka,ib,kb,jlac,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_bbbb, t1_ce_bb, optimize = einsum_type)
        IblK += 1/2 * einsum('ij,ka,ib,kb,ljca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ka,ib,kc,ljba,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ka,ib,lb,kjca,lc', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ccee_abab, t1_ce_aa, optimize = einsum_type)
        IblK -= 1/2 * einsum('ij,ka,ib,la,kjbc,lc', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ccee_abab, t1_ce_bb, optimize = einsum_type)
        IblK -= einsum('ij,ka,ja,lb,ic,klbc', S_oo_ab, S_ov_ab, Y_bb, Y_aa, t1_ce_aa, t1_ccee_aaaa, optimize = einsum_type)
        IblK += einsum('ij,ka,ja,lb,ic,klcb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('ij,ka,jb,lb,ic,klca', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('ij,ka,kb,lb,ic,ljca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK += einsum('ij,ka,kb,lc,ib,ljca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK += einsum('ij,ka,kb,lc,ib,jlac', S_oo_ab, S_ov_ab, Y_aa, Y_bb, t1_ce_aa, t1_ccee_bbbb, optimize = einsum_type)
        IblK += einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('ij,ka,lb,lc,ib,kjca', S_oo_ab, S_ov_ab, Y_aa, Y_aa, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK -= einsum('ij,ka,la,lb,ic,kjcb', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        IblK += einsum('ij,ka,lb,lb,ic,kjca', S_oo_ab, S_ov_ab, Y_bb, Y_bb, t1_ce_aa, t1_ccee_abab, optimize = einsum_type)
        ...
        if (method == "adc(2)-x") or (method == "adc(3)"):
            ...
            AbcL +=- einsum('ia,bc,ib,jkda,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            AbcL -= 1/2 * einsum('ia,bc,ib,jkad,jkcd', S_ov_ab, S_vv_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            AbcL += einsum('ia,bc,id,jkba,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            ...
            AbcL += einsum('ia,bc,jb,ikda,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            
            
            AblC +=- einsum('ai,bc,ja,ikcd,jkbd', S_vo_ab, S_vv_ab, t1_ce_aa, Y_bbbb, Y_abab, optimize = einsum_type)
            AblC -= einsum('ai,bc,ja,kidc,jkbd', S_vo_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_aaaa, optimize = einsum_type)
            AblC -= 1/2 * einsum('ai,bc,ic,jkad,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AblC -= einsum('ai,bc,ic,jkad,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AblC += einsum('ai,bc,id,jkac,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AblC += einsum('ai,bc,jc,kiad,kjbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            
            
            AjdC +=- einsum('ai,bc,ja,ikcd,jkbd', S_vo_ab, S_vv_ab, t1_ce_aa, Y_bbbb, Y_abab, optimize = einsum_type)
            AjdC -= einsum('ai,bc,ja,kidc,jkbd', S_vo_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_aaaa, optimize = einsum_type)
            AjdC -= 1/2 * einsum('ai,bc,ic,jkad,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            AjdC -= einsum('ai,bc,ic,jkad,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            AjdC += einsum('ai,bc,id,jkac,jkbd', S_vo_ab, S_vv_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            ...
            AjlK -= 1/4 * einsum('ij,aj,ia,klbc,klbc', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            ...
            AjlK += 1/2 * einsum('ij,ak,ia,jlbc,klbc', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            ...
            AjlK += einsum('ij,ak,kb,ilac,ljcb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_aaaa, Y_abab, optimize = einsum_type)
            AjlK += einsum('ij,ak,kb,ilac,jlbc', S_oo_ab, S_vo_ab, t1_ce_bb, Y_abab, Y_bbbb, optimize = einsum_type)
            
            IbdC +=- einsum('ia,bc,ib,jkda,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            IbdC -= 1/2 * einsum('ia,bc,ib,jkad,jkcd', S_ov_ab, S_vv_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IbdC += einsum('ia,bc,id,jkba,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            ...
            IbdC += einsum('ia,bc,jb,ikda,jkdc', S_ov_ab, S_vv_ab, t1_ce_aa, Y_abab, Y_abab, optimize = einsum_type)
            
            IblK +=- 1/4 * einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IblK -= einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= 1/4 * einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IblK += einsum('ij,ia,jb,klca,klcb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK += 1/2 * einsum('ij,ia,jb,klac,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IblK += 1/2 * einsum('ij,ia,ka,jlbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IblK += einsum('ij,ia,ka,ljbc,lkbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK += 1/2 * einsum('ij,ka,ja,ilbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IblK += einsum('ij,ka,ja,ilbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK -= einsum('ij,ka,jb,ilcb,klca', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IblK += einsum('ij,ka,kb,ilbc,ljca', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            IblK += einsum('ij,ka,kb,ilbc,jlac', S_oo_ab, S_ov_ab, t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            IblK -= einsum('ij,ka,la,ilbc,kjbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            
            
            IjdL +=- 1/4 * einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjdL -= einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjdL -= 1/4 * einsum('ij,ia,ja,klbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjdL += einsum('ij,ia,jb,klca,klcb', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjdL += 1/2 * einsum('ij,ia,jb,klac,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjdL += 1/2 * einsum('ij,ia,ka,jlbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_bbbb, Y_bbbb, optimize = einsum_type)
            IjdL += einsum('ij,ia,ka,ljbc,lkbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjdL += 1/2 * einsum('ij,ka,ja,ilbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_aaaa, Y_aaaa, optimize = einsum_type)
            IjdL += einsum('ij,ka,ja,ilbc,klbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjdL -= einsum('ij,ka,jb,ilcb,klca', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            IjdL += einsum('ij,ka,kb,ilbc,ljca', S_oo_ab, S_ov_ab, t1_ce_aa, Y_aaaa, Y_abab, optimize = einsum_type)
            IjdL += einsum('ij,ka,kb,ilbc,jlac', S_oo_ab, S_ov_ab, t1_ce_aa, Y_abab, Y_bbbb, optimize = einsum_type)
            IjdL -= einsum('ij,ka,la,ilbc,kjbc', S_oo_ab, S_ov_ab, t1_ce_bb, Y_abab, Y_abab, optimize = einsum_type)
            ...
            IjlD -= 1/4 * einsum('ij,aj,ia,klbc,klbc', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            ...
            IjlD += 1/2 * einsum('ij,ak,ia,jlbc,klbc', S_oo_ab, S_vo_ab, t1_ce_aa, Y_bbbb, Y_bbbb, optimize = einsum_type)
            ...
            IjlD += einsum('ij,ak,kb,ilac,ljcb', S_oo_ab, S_vo_ab, t1_ce_bb, Y_aaaa, Y_abab, optimize = einsum_type)

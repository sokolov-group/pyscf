...
def transform_integrals_outcore(myadc):
    ...
    ncvs = ncvs = ncvs # This is unecessary. ncvs and ncvs can be simply replaced with ncvs
...
def transform_integrals_df(myadc):
    ...
    if myadc.method_type == 'ip-cvs':
        ...
        #eris.ceee[:] = lib.ddot(eris.L_ce.T,eris.L_ee).reshape((ncvs, nvir_a, nvpair_a        ))
        #eris.CEEE[:] = lib.ddot(eris.L_CE.T,eris.L_EE).reshape((ncvs, nvir_b, nvpair_b        ))
        #eris.ceEE[:] = lib.ddot(eris.L_ce.T,eris.L_EE).reshape((ncvs, nvir_a, nvpair_b        ))
        #eris.CEee[:] = lib.ddot(eris.L_CE.T,eris.L_ee).reshape((ncvs, nvir_b, nvpair_a        ))
